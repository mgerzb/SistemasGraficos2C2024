...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function Sh(){return new Hn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:tc(),fragmentShader:`
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function wh(){return new Hn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:tc(),fragmentShader:`
	...
	`}function t_(r){let t=new WeakMap,e=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Al||l===Tl,h=l===Ns||l===Os;if(c||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=t.get(a);return e===null&&(e=new Mh(r)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),t.set(a,u),u.texture}else{if(t.has(a))return t.get(a).texture;{const u=a.image;if(c&&u&&u.height>0||h&&u&&i(u)){e===null&&(e=new Mh(r));const d=c?e.fromEquirectangular(a):e.fromCubemap(a);return t.set(a,d),a.addEventListener("dispose",s),d.texture}else return null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:o}}function e_(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(n){n.isWebGL2?(e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance")):(e("WEBGL_depth_texture"),e("OES_texture_float"),e("OES_texture_half_float"),e("OES_texture_half_float_linear"),e("OES_standard_derivatives"),e("OES_element_index_uint"),e("OES_vertex_array_object"),e("ANGLE_instanced_arrays")),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture")},get:function(n){const i=e(n);return i===null&&console.warn("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function n_(r,t,e,n){const i={},s=new WeakMap;function o(u){const d=u.target;d.index!==null&&t.remove(d.index);for(const g in d.attributes)t.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let p=0,m=_.length;p<m;p++)t.remove(_[p])}d.removeEventListener("dispose",o),delete i[d.id];const f=s.get(d);f&&(t.remove(f),s.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,e.memory.geometries--}function a(u,d){return i[d.id]===!0||(d.addEventListener("dispose",o),i[d.id]=!0,e.memory.geometries++),d}function l(u){const d=u.attributes;for(const g in d)t.update(d[g],r.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const _=f[g];for(let p=0,m=_.length;p<m;p++)t.update(_[p],r.ARRAY_BUFFER)}}function c(u){const d=[],f=u.index,g=u.attributes.position;let _=0;if(f!==null){const S=f.array;_=f.version;for(let x=0,b=S.length;x<b;x+=3){const R=S[x+0],A=S[x+1],w=S[x+2];d.push(R,A,A,w,w,R)}}else if(g!==void 0){const S=g.array;_=g.version;for(let x=0,b=S.length/3-1;x<b;x+=3){const R=x+0,A=x+1,w=x+2;d.push(R,A,A,w,w,R)}}else return;const p=new(wd(d)?Id:Dd)(d,1);p.version=_;const m=s.get(u);m&&t.remove(m),s.set(u,p)}function h(u){const d=s.get(u);if(d){const f=u.index;f!==null&&d.version<f.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function i_(r,t,e,n){const i=n.isWebGL2;let s;function o(f){s=f}let a,l;function c(f){a=f.type,l=f.bytesPerElement}function h(f,g){r.drawElements(s,g,a,f*l),e.update(g,s,1)}function u(f,g,_){if(_===0)return;let p,m;if(i)p=r,m="drawElementsInstanced";else if(p=t.get("ANGLE_instanced_arrays"),m="drawElementsInstancedANGLE",p===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}p[m](s,g,a,f*l,_),e.update(g,s,_)}function d(f,g,_){if(_===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let m=0;m<_;m++)this.render(f[m]/l,g[m]);else{p.multiDrawElementsWEBGL(s,g,0,a,f,0,_);let m=0;for(let S=0;S<_;S++)m+=g[S];e.update(m,s,1)}}this.setMode=o,this.setIndex=c,this.render=h,this.renderInstances=u,this.renderMultiDraw=d}function s_(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(e.calls++,o){case r.TRIANGLES:e.triangles+=a*(s/3);break;case r.LINES:e.lines+=a*(s/2);break;case r.LINE_STRIP:e.lines+=a*(s-1);break;case r.LINE_LOOP:e.lines+=a*s;break;case r.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function r_(r,t){return r[0]-t[0]}function a_(r,t){return Math.abs(t[1])-Math.abs(r[1])}function o_(r,t,e){const n={},i=new Float32Array(8),s=new WeakMap,o=new de,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,h,u){const d=c.morphTargetInfluences;if(t.isWebGL2===!0){const g=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=g!==void 0?g.length:0;let p=s.get(h);if(p===void 0||p.count!==_){let q=function(){T.dispose(),s.delete(h),h.removeEventListener("dispose",q)};var f=q;p!==void 0&&p.texture.dispose();const m=h.morphAttributes.position!==void 0,S=h.morphAttributes.normal!==void 0,x=h.morphAttributes.color!==void 0,b=h.morphAttributes.position||[],R=h.morphAttributes.normal||[],A=h.morphAttributes.color||[];let w=0;m===!0&&(w=1),S===!0&&(w=2),x===!0&&(w=3);let I=h.attributes.position.count*w,X=1;I>t.maxTextureSize&&(X=Math.ceil(I/t.maxTextureSize),I=t.maxTextureSize);const y=new Float32Array(I*X*4*_),T=new Cd(y,I,X,_);T.type=On,T.needsUpdate=!0;const j=w*4;for(let L=0;L<_;L++){const V=b[L],O=R[L],J=A[L],G=I*X*4*L;for(let $=0;$<V.count;$++){const Z=$*j;m===!0&&(o.fromBufferAttribute(V,$),y[G+Z+0]=o.x,y[G+Z+1]=o.y,y[G+Z+2]=o.z,y[G+Z+3]=0),S===!0&&(o.fromBufferAttribute(O,$),y[G+Z+4]=o.x,y[G+Z+5]=o.y,y[G+Z+6]=o.z,y[G+Z+7]=0),x===!0&&(o.fromBufferAttribute(J,$),y[G+Z+8]=o.x,y[G+Z+9]=o.y,y[G+Z+10]=o.z,y[G+Z+11]=J.itemSize===4?o.w:1)}}p={count:_,texture:T,size:new pt(I,X)},s.set(h,p),h.addEventListener("dispose",q)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)u.getUniforms().setValue(r,"morphTexture",c.morphTexture,e);else{let m=0;for(let x=0;x<d.length;x++)m+=d[x];const S=h.morphTargetsRelative?1:1-m;u.getUniforms().setValue(r,"morphTargetBaseInfluence",S),u.getUniforms().setValue(r,"morphTargetInfluences",d)}u.getUniforms().setValue(r,"morphTargetsTexture",p.texture,e),u.getUniforms().setValue(r,"morphTargetsTextureSize",p.size)}else{const g=d===void 0?0:d.length;let _=n[h.id];if(_===void 0||_.length!==g){_=[];for(let b=0;b<g;b++)_[b]=[b,0];n[h.id]=_}for(let b=0;b<g;b++){const R=_[b];R[0]=b,R[1]=d[b]}_.sort(a_);for(let b=0;b<8;b++)b<g&&_[b][1]?(a[b][0]=_[b][0],a[b][1]=_[b][1]):(a[b][0]=Number.MAX_SAFE_INTEGER,a[b][1]=0);a.sort(r_);const p=h.morphAttributes.position,m=h.morphAttributes.normal;let S=0;for(let b=0;b<8;b++){const R=a[b],A=R[0],w=R[1];A!==Number.MAX_SAFE_INTEGER&&w?(p&&h.getAttribute("morphTarget"+b)!==p[A]&&h.setAttribute("morphTarget"+b,p[A]),m&&h.getAttribute("morphNormal"+b)!==m[A]&&h.setAttribute("morphNormal"+b,m[A]),i[b]=w,S+=w):(p&&h.hasAttribute("morphTarget"+b)===!0&&h.deleteAttribute("morphTarget"+b),m&&h.hasAttribute("morphNormal"+b)===!0&&h.deleteAttribute("morphNormal"+b),i[b]=0)}const x=h.morphTargetsRelative?1:1-S;u.getUniforms().setValue(r,"morphTargetBaseInfluence",x),u.getUniforms().setValue(r,"morphTargetInfluences",i)}}return{update:l}}function l_(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;i.get(d)!==c&&(d.update(),i.set(d,c))}return u}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}class Hd extends dn{constructor(t,e,n,i,s,o,a,l,c,h){if(h=h!==void 0?h:zi,h!==zi&&h!==zs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===zi&&(n=ai),n===void 0&&h===zs&&(n=Oi),super(null,i,s,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=a!==void 0?a:Be,this.minFilter=l!==void 0?l:Be,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Vd=new dn,Gd=new Hd(1,1);Gd.compareFunction=Md;const Wd=new Cd,Xd=new Xp,Yd=new zd,Eh=[],Ah=[],Th=new Float32Array(16),Ch=new Float32Array(9),Rh=new Float32Array(4);function Vs(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=Eh[i];if(s===void 0&&(s=new Float32Array(i),Eh[i]=s),t!==0){n.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,r[o].toArray(s,a)}return s}function ye(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function Me(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function Qa(r,t){let e=Ah[t];e===void 0&&(e=new Int32Array(t),Ah[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function c_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function h_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;r.uniform2fv(this.addr,t),Me(e,t)}}function u_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ye(e,t))return;r.uniform3fv(this.addr,t),Me(e,t)}}function d_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;r.uniform4fv(this.addr,t),Me(e,t)}}function f_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),Me(e,t)}else{if(ye(e,n))return;Rh.set(n),r.uniformMatrix2fv(this.addr,!1,Rh),Me(e,n)}}function p_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),Me(e,t)}else{if(ye(e,n))return;Ch.set(n),r.uniformMatrix3fv(this.addr,!1,Ch),Me(e,n)}}function m_(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(ye(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),Me(e,t)}else{if(ye(e,n))return;Th.set(n),r.uniformMatrix4fv(this.addr,!1,Th),Me(e,n)}}function g_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function __(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;r.uniform2iv(this.addr,t),Me(e,t)}}function x_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ye(e,t))return;r.uniform3iv(this.addr,t),Me(e,t)}}function v_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;r.uniform4iv(this.addr,t),Me(e,t)}}function y_(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function M_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ye(e,t))return;r.uniform2uiv(this.addr,t),Me(e,t)}}function b_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ye(e,t))return;r.uniform3uiv(this.addr,t),Me(e,t)}}function S_(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ye(e,t))return;r.uniform4uiv(this.addr,t),Me(e,t)}}function w_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);const s=this.type===r.SAMPLER_2D_SHADOW?Gd:Vd;e.setTexture2D(t||s,i)}function E_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Xd,i)}function A_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||Yd,i)}function T_(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||Wd,i)}function C_(r){switch(r){case 5126:return c_;case 35664:return h_;case 35665:return u_;case 35666:return d_;case 35674:return f_;case 35675:return p_;case 35676:return m_;case 5124:case 35670:return g_;case 35667:case 35671:return __;case 35668:case 35672:return x_;case 35669:case 35673:return v_;case 5125:return y_;case 36294:return M_;case 36295:return b_;case 36296:return S_;case 35678:case 36198:case 36298:case 36306:case 35682:return w_;case 35679:case 36299:case 36307:return E_;case 35680:case 36300:case 36308:case 36293:return A_;case 36289:case 36303:case 36311:case 36292:return T_}}function R_(r,t){r.uniform1fv(this.addr,t)}function P_(r,t){const e=Vs(t,this.size,2);r.uniform2fv(this.addr,e)}function L_(r,t){const e=Vs(t,this.size,3);r.uniform3fv(this.addr,e)}function D_(r,t){const e=Vs(t,this.size,4);r.uniform4fv(this.addr,e)}function I_(r,t){const e=Vs(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function F_(r,t){const e=Vs(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function U_(r,t){const e=Vs(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function N_(r,t){r.uniform1iv(this.addr,t)}function O_(r,t){r.uniform2iv(this.addr,t)}function z_(r,t){r.uniform3iv(this.addr,t)}function B_(r,t){r.uniform4iv(this.addr,t)}function k_(r,t){r.uniform1uiv(this.addr,t)}function H_(r,t){r.uniform2uiv(this.addr,t)}function V_(r,t){r.uniform3uiv(this.addr,t)}function G_(r,t){r.uniform4uiv(this.addr,t)}function W_(r,t,e){const n=this.cache,i=t.length,s=Qa(e,i);ye(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let o=0;o!==i;++o)e.setTexture2D(t[o]||Vd,s[o])}function X_(r,t,e){const n=this.cache,i=t.length,s=Qa(e,i);ye(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let o=0;o!==i;++o)e.setTexture3D(t[o]||Xd,s[o])}function Y_(r,t,e){const n=this.cache,i=t.length,s=Qa(e,i);ye(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let o=0;o!==i;++o)e.setTextureCube(t[o]||Yd,s[o])}function q_(r,t,e){const n=this.cache,i=t.length,s=Qa(e,i);ye(n,s)||(r.uniform1iv(this.addr,s),Me(n,s));for(let o=0;o!==i;++o)e.setTexture2DArray(t[o]||Wd,s[o])}function $_(r){switch(r){case 5126:return R_;case 35664:return P_;case 35665:return L_;case 35666:return D_;case 35674:return I_;case 35675:return F_;case 35676:return U_;case 5124:case 35670:return N_;case 35667:case 35671:return O_;case 35668:case 35672:return z_;case 35669:case 35673:return B_;case 5125:return k_;case 36294:return H_;case 36295:return V_;case 36296:return G_;case 35678:case 36198:case 36298:case 36306:case 35682:return W_;case 35679:case 36299:case 36307:return X_;case 35680:case 36300:case 36308:case 36293:return Y_;case 36289:case 36303:case 36311:case 36292:return q_}}class j_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=C_(e.type)}}class Z_{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=$_(e.type)}}class K_{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const Oo=/(\w+)(\])?(\[|\.)?/g;function Ph(r,t){r.seq.push(t),r.map[t.id]=t}function J_(r,t,e){const n=r.name,i=n.length;for(Oo.lastIndex=0;;){const s=Oo.exec(n),o=Oo.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){Ph(e,c===void 0?new j_(a,r,t):new Z_(a,r,t));break}else{let u=e.map[a];u===void 0&&(u=new K_(a),Ph(e,u)),e=u}}}class La{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),o=t.getUniformLocation(e,s.name);J_(s,o,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=n[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const o=t[i];o.id in e&&n.push(o)}return n}}function Lh(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const Q_=37297;let tx=0;function ex(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return n.join(`
`)}function nx(r){const t=te.getPrimaries(te.workingColorSpace),e=te.getPrimaries(r);let n;switch(t===e?n="":t===za&&e===Oa?n="LinearDisplayP3ToLinearSRGB":t===Oa&&e===za&&(n="LinearSRGBToLinearDisplayP3"),r){case fi:case ja:return[n,"LinearTransferOETF"];case gn:case $l:return[n,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",r),[n,"LinearTransferOETF"]}}function Dh(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`
...
#define LOW_PRECISION`),t}function px(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===dd?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===Cf?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Un&&(t="SHADOWMAP_TYPE_VSM"),t}function mx(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ns:case Os:t="ENVMAP_TYPE_CUBE";break;case $a:t="ENVMAP_TYPE_CUBE_UV";break}return t}function gx(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Os:t="ENVMAP_MODE_REFRACTION";break}return t}function _x(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Xl:t="ENVMAP_BLENDING_MULTIPLY";break;case Jf:t="ENVMAP_BLENDING_MIX";break;case Qf:t="ENVMAP_BLENDING_ADD";break}return t}function xx(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function vx(r,t,e,n){const i=r.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=px(e),c=mx(e),h=gx(e),u=_x(e),d=xx(e),f=e.isWebGL2?"":rx(e),g=ax(e),_=ox(s),p=i.createProgram();let m,S,x=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+m,S=["precision mediump sampler2DArray;","#define varying in",e.glslVersion===Jc?"":"layout(location = 0) out highp vec4 pc_fragColor;",e.glslVersion===Jc?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+S);const b=x+m+o,R=x+S+a,A=Lh(i,i.VERTEX_SHADER,b),w=Lh(i,i.FRAGMENT_SHADER,R);i.attachShader(p,A),i.attachShader(p,w),e.index0AttributeName!==void 0?i.bindAttribLocation(p,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(p,0,"position"),i.linkProgram(p);function I(j){if(r.debug.checkShaderErrors){const q=i.getProgramInfoLog(p).trim(),L=i.getShaderInfoLog(A).trim(),V=i.getShaderInfoLog(w).trim();let O=!0,J=!0;if(i.getProgramParameter(p,i.LINK_STATUS)===!1)if(O=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,p,A,w);else{const G=Dh(i,A,"vertex"),$=Dh(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(p,i.VALIDATE_STATUS)+`
...
`;class oc extends sf{constructor(t){super(),this.isShaderMaterial=!0,this.type="ShaderMaterial",this.defines={},this.uniforms={},this.uniformsGroups=[],this.vertexShader=ay,this.fragmentShader=oy,this.linewidth=1,this.wireframe=!1,this.wireframeLinewidth=1,this.fog=!1,this.lights=!1,this.clipping=!1,this.forceSinglePass=!0,this.extensions={derivatives:!1,fragDepth:!1,drawBuffers:!1,shaderTextureLOD:!1,clipCullDistance:!1,multiDraw:!1},this.defaultAttributeValues={color:[1,1,1],uv:[0,0],uv1:[0,0]},this.index0AttributeName=void 0,this.uniformsNeedUpdate=!1,this.glslVersion=null,t!==void 0&&this.setValues(t)}copy(t){return super.copy(t),this.fragmentShader=t.fragmentShader,this.vertexShader=t.vertexShader,this.uniforms=sy(t.uniforms),this.uniformsGroups=ry(t.uniformsGroups),this.defines=Object.assign({},t.defines),this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.fog=t.fog,this.lights=t.lights,this.clipping=t.clipping,this.extensions=Object.assign({},t.extensions),this.glslVersion=t.glslVersion,this}toJSON(t){const e=super.toJSON(t);e.glslVersion=this.glslVersion,e.uniforms={};for(const i in this.uniforms){const o=this.uniforms[i].value;o&&o.isTexture?e.uniforms[i]={type:"t",value:o.toJSON(t).uuid}:o&&o.isColor?e.uniforms[i]={type:"c",value:o.getHex()}:o&&o.isVector2?e.uniforms[i]={type:"v2",value:o.toArray()}:o&&o.isVector3?e.uniforms[i]={type:"v3",value:o.toArray()}:o&&o.isVector4?e.uniforms[i]={type:"v4",value:o.toArray()}:o&&o.isMatrix3?e.uniforms[i]={type:"m3",value:o.toArray()}:o&&o.isMatrix4?e.uniforms[i]={type:"m4",value:o.toArray()}:e.uniforms[i]={value:o}}Object.keys(this.defines).length>0&&(e.defines=this.defines),e.vertexShader=this.vertexShader,e.fragmentShader=this.fragmentShader,e.lights=this.lights,e.clipping=this.clipping;const n={};for(const i in this.extensions)this.extensions[i]===!0&&(n[i]=!0);return Object.keys(n).length>0&&(e.extensions=n),e}}let vs;class ly{static getDataURL(t){if(/^data:/i.test(t.src)||typeof HTMLCanvasElement>"u")return t.src;let e;if(t instanceof HTMLCanvasElement)e=t;else{vs===void 0&&(vs=wu("canvas")),vs.width=t.width,vs.height=t.height;const n=vs.getContext("2d");t instanceof ImageData?n.putImageData(t,0,0):n.drawImage(t,0,0,t.width,t.height),e=vs}return e.width>2048||e.height>2048?(console.warn("THREE.ImageUtils.getDataURL: Image converted to jpg for performance reasons",t),e.toDataURL("image/jpeg",.6)):e.toDataURL("image/png")}static sRGBToLinear(t){if(typeof HTMLImageElement<"u"&&t instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&t instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&t instanceof ImageBitmap){const e=wu("canvas");e.width=t.width,e.height=t.height;const n=e.getContext("2d");n.drawImage(t,0,0,t.width,t.height);const i=n.getImageData(0,0,t.width,t.height),s=i.data;for(let o=0;o<s.length;o++)s[o]=Is(s[o]/255)*255;return n.putImageData(i,0,0),e}else if(t.data){const e=t.data.slice(0);for(let n=0;n<e.length;n++)e instanceof Uint8Array||e instanceof Uint8ClampedArray?e[n]=Math.floor(Is(e[n]/255)*255):e[n]=Is(e[n]);return{data:e,width:t.width,height:t.height}}else return console.warn("THREE.ImageUtils.sRGBToLinear(): Unsupported image type. No color space conversion applied."),t}}let cy=0;class of{constructor(t=null){this.isSource=!0,Object.defineProperty(this,"id",{value:cy++}),this.uuid=yr(),this.data=t,this.dataReady=!0,this.version=0}set needsUpdate(t){t===!0&&this.version++}toJSON(t){const e=t===void 0||typeof t=="string";if(!e&&t.images[this.uuid]!==void 0)return t.images[this.uuid];const n={uuid:this.uuid,url:""},i=this.data;if(i!==null){let s;if(Array.isArray(i)){s=[];for(let o=0,a=i.length;o<a;o++)i[o].isDataTexture?s.push(ml(i[o].image)):s.push(ml(i[o]))}else s=ml(i);n.url=s}return e||(t.images[this.uuid]=n),n}}function ml(r){return typeof HTMLImageElement<"u"&&r instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&r instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&r instanceof ImageBitmap?ly.getDataURL(r):r.data?{data:Array.from(r.data),width:r.width,height:r.height,type:r.data.constructor.name}:(console.warn("THREE.Texture: Unable to serialize Texture."),{})}let hy=0;class hi extends Sr{constructor(t=hi.DEFAULT_IMAGE,e=hi.DEFAULT_MAPPING,n=ra,i=ra,s=Ga,o=Dv,a=Jd,l=Iv,c=hi.DEFAULT_ANISOTROPY,h=Qd){super(),this.isTexture=!0,Object.defineProperty(this,"id",{value:hy++}),this.uuid=yr(),this.name="",this.source=new of(t),this.mipmaps=[],this.mapping=e,this.channel=0,this.wrapS=n,this.wrapT=i,this.magFilter=s,this.minFilter=o,this.anisotropy=c,this.format=a,this.internalFormat=null,this.type=l,this.offset=new Ue(0,0),this.repeat=new Ue(1,1),this.center=new Ue(0,0),this.rotation=0,this.matrixAutoUpdate=!0,this.matrix=new pi,this.generateMipmaps=!0,this.premultiplyAlpha=!1,this.flipY=!0,this.unpackAlignment=4,this.colorSpace=h,this.userData={},this.version=0,this.onUpdate=null,this.isRenderTargetTexture=!1,this.needsPMREMUpdate=!1}get image(){return this.source.data}set image(t=null){this.source.data=t}updateMatrix(){this.matrix.setUvTransform(this.offset.x,this.offset.y,this.repeat.x,this.repeat.y,this.rotation,this.center.x,this.center.y)}clone(){return new this.constructor().copy(this)}copy(t){return this.name=t.name,this.source=t.source,this.mipmaps=t.mipmaps.slice(0),this.mapping=t.mapping,this.channel=t.channel,this.wrapS=t.wrapS,this.wrapT=t.wrapT,this.magFilter=t.magFilter,this.minFilter=t.minFilter,this.anisotropy=t.anisotropy,this.format=t.format,this.internalFormat=t.internalFormat,this.type=t.type,this.offset.copy(t.offset),this.repeat.copy(t.repeat),this.center.copy(t.center),this.rotation=t.rotation,this.matrixAutoUpdate=t.matrixAutoUpdate,this.matrix.copy(t.matrix),this.generateMipmaps=t.generateMipmaps,this.premultiplyAlpha=t.premultiplyAlpha,this.flipY=t.flipY,this.unpackAlignment=t.unpackAlignment,this.colorSpace=t.colorSpace,this.userData=JSON.parse(JSON.stringify(t.userData)),this.needsUpdate=!0,this}toJSON(t){const e=t===void 0||typeof t=="string";if(!e&&t.textures[this.uuid]!==void 0)return t.textures[this.uuid];const n={metadata:{version:4.6,type:"Texture",generator:"Texture.toJSON"},uuid:this.uuid,name:this.name,image:this.source.toJSON(t).uuid,mapping:this.mapping,channel:this.channel,repeat:[this.repeat.x,this.repeat.y],offset:[this.offset.x,this.offset.y],center:[this.center.x,this.center.y],rotation:this.rotation,wrap:[this.wrapS,this.wrapT],format:this.format,internalFormat:this.internalFormat,type:this.type,colorSpace:this.colorSpace,minFilter:this.minFilter,magFilter:this.magFilter,anisotropy:this.anisotropy,flipY:this.flipY,generateMipmaps:this.generateMipmaps,premultiplyAlpha:this.premultiplyAlpha,unpackAlignment:this.unpackAlignment};return Object.keys(this.userData).length>0&&(n.userData=this.userData),e||(t.textures[this.uuid]=n),n}dispose(){this.dispatchEvent({type:"dispose"})}transformUv(t){if(this.mapping!==Kd)return t;if(t.applyMatrix3(this.matrix),t.x<0||t.x>1)switch(this.wrapS){case pu:t.x=t.x-Math.floor(t.x);break;case ra:t.x=t.x<0?0:1;break;case mu:Math.abs(Math.floor(t.x)%2)===1?t.x=Math.ceil(t.x)-t.x:t.x=t.x-Math.floor(t.x);break}if(t.y<0||t.y>1)switch(this.wrapT){case pu:t.y=t.y-Math.floor(t.y);break;case ra:t.y=t.y<0?0:1;break;case mu:Math.abs(Math.floor(t.y)%2)===1?t.y=Math.ceil(t.y)-t.y:t.y=t.y-Math.floor(t.y);break}return this.flipY&&(t.y=1-t.y),t}set needsUpdate(t){t===!0&&(this.version++,this.source.needsUpdate=!0)}}hi.DEFAULT_IMAGE=null;hi.DEFAULT_MAPPING=Kd;hi.DEFAULT_ANISOTROPY=1;class Wa{constructor(t=0,e=0,n=0,i=1){Wa.prototype.isVector4=!0,this.x=t,this.y=e,this.z=n,this.w=i}get width(){return this.z}set width(t){this.z=t}get height(){return this.w}set height(t){this.w=t}set(t,e,n,i){return this.x=t,this.y=e,this.z=n,this.w=i,this}setScalar(t){return this.x=t,this.y=t,this.z=t,this.w=t,this}setX(t){return this.x=t,this}setY(t){return this.y=t,this}setZ(t){return this.z=t,this}setW(t){return this.w=t,this}setComponent(t,e){switch(t){case 0:this.x=e;break;case 1:this.y=e;break;case 2:this.z=e;break;case 3:this.w=e;break;default:throw new Error("index is out of range: "+t)}return this}getComponent(t){switch(t){case 0:return this.x;case 1:return this.y;case 2:return this.z;case 3:return this.w;default:throw new Error("index is out of range: "+t)}}clone(){return new this.constructor(this.x,this.y,this.z,this.w)}copy(t){return this.x=t.x,this.y=t.y,this.z=t.z,this.w=t.w!==void 0?t.w:1,this}add(t){return this.x+=t.x,this.y+=t.y,this.z+=t.z,this.w+=t.w,this}addScalar(t){return this.x+=t,this.y+=t,this.z+=t,this.w+=t,this}addVectors(t,e){return this.x=t.x+e.x,this.y=t.y+e.y,this.z=t.z+e.z,this.w=t.w+e.w,this}addScaledVector(t,e){return this.x+=t.x*e,this.y+=t.y*e,this.z+=t.z*e,this.w+=t.w*e,this}sub(t){return this.x-=t.x,this.y-=t.y,this.z-=t.z,this.w-=t.w,this}subScalar(t){return this.x-=t,this.y-=t,this.z-=t,this.w-=t,this}subVectors(t,e){return this.x=t.x-e.x,this.y=t.y-e.y,this.z=t.z-e.z,this.w=t.w-e.w,this}multiply(t){return this.x*=t.x,this.y*=t.y,this.z*=t.z,this.w*=t.w,this}multiplyScalar(t){return this.x*=t,this.y*=t,this.z*=t,this.w*=t,this}applyMatrix4(t){const e=this.x,n=this.y,i=this.z,s=this.w,o=t.elements;return this.x=o[0]*e+o[4]*n+o[8]*i+o[12]*s,this.y=o[1]*e+o[5]*n+o[9]*i+o[13]*s,this.z=o[2]*e+o[6]*n+o[10]*i+o[14]*s,this.w=o[3]*e+o[7]*n+o[11]*i+o[15]*s,this}divideScalar(t){return this.multiplyScalar(1/t)}setAxisAngleFromQuaternion(t){this.w=2*Math.acos(t.w);const e=Math.sqrt(1-t.w*t.w);return e<1e-4?(this.x=1,this.y=0,this.z=0):(this.x=t.x/e,this.y=t.y/e,this.z=t.z/e),this}setAxisAngleFromRotationMatrix(t){let e,n,i,s;const l=t.elements,c=l[0],h=l[4],u=l[8],d=l[1],f=l[5],g=l[9],_=l[2],p=l[6],m=l[10];if(Math.abs(h-d)<.01&&Math.abs(u-_)<.01&&Math.abs(g-p)<.01){if(Math.abs(h+d)<.1&&Math.abs(u+_)<.1&&Math.abs(g+p)<.1&&Math.abs(c+f+m-3)<.1)return this.set(1,0,0,0),this;e=Math.PI;const x=(c+1)/2,b=(f+1)/2,R=(m+1)/2,A=(h+d)/4,w=(u+_)/4,I=(g+p)/4;return x>b&&x>R?x<.01?(n=0,i=.707106781,s=.707106781):(n=Math.sqrt(x),i=A/n,s=w/n):b>R?b<.01?(n=.707106781,i=0,s=.707106781):(i=Math.sqrt(b),n=A/i,s=I/i):R<.01?(n=.707106781,i=.707106781,s=0):(s=Math.sqrt(R),n=w/s,i=I/s),this.set(n,i,s,e),this}let S=Math.sqrt((p-g)*(p-g)+(u-_)*(u-_)+(d-h)*(d-h));return Math.abs(S)<.001&&(S=1),this.x=(p-g)/S,this.y=(u-_)/S,this.z=(d-h)/S,this.w=Math.acos((c+f+m-1)/2),this}min(t){return this.x=Math.min(this.x,t.x),this.y=Math.min(this.y,t.y),this.z=Math.min(this.z,t.z),this.w=Math.min(this.w,t.w),this}max(t){return this.x=Math.max(this.x,t.x),this.y=Math.max(this.y,t.y),this.z=Math.max(this.z,t.z),this.w=Math.max(this.w,t.w),this}clamp(t,e){return this.x=Math.max(t.x,Math.min(e.x,this.x)),this.y=Math.max(t.y,Math.min(e.y,this.y)),this.z=Math.max(t.z,Math.min(e.z,this.z)),this.w=Math.max(t.w,Math.min(e.w,this.w)),this}clampScalar(t,e){return this.x=Math.max(t,Math.min(e,this.x)),this.y=Math.max(t,Math.min(e,this.y)),this.z=Math.max(t,Math.min(e,this.z)),this.w=Math.max(t,Math.min(e,this.w)),this}clampLength(t,e){const n=this.length();return this.divideScalar(n||1).multiplyScalar(Math.max(t,Math.min(e,n)))}floor(){return this.x=Math.floor(this.x),this.y=Math.floor(this.y),this.z=Math.floor(this.z),this.w=Math.floor(this.w),this}ceil(){return this.x=Math.ceil(this.x),this.y=Math.ceil(this.y),this.z=Math.ceil(this.z),this.w=Math.ceil(this.w),this}round(){return this.x=Math.round(this.x),this.y=Math.round(this.y),this.z=Math.round(this.z),this.w=Math.round(this.w),this}roundToZero(){return this.x=Math.trunc(this.x),this.y=Math.trunc(this.y),this.z=Math.trunc(this.z),this.w=Math.trunc(this.w),this}negate(){return this.x=-this.x,this.y=-this.y,this.z=-this.z,this.w=-this.w,this}dot(t){return this.x*t.x+this.y*t.y+this.z*t.z+this.w*t.w}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w}length(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z+this.w*this.w)}manhattanLength(){return Math.abs(this.x)+Math.abs(this.y)+Math.abs(this.z)+Math.abs(this.w)}normalize(){return this.divideScalar(this.length()||1)}setLength(t){return this.normalize().multiplyScalar(t)}lerp(t,e){return this.x+=(t.x-this.x)*e,this.y+=(t.y-this.y)*e,this.z+=(t.z-this.z)*e,this.w+=(t.w-this.w)*e,this}lerpVectors(t,e,n){return this.x=t.x+(e.x-t.x)*n,this.y=t.y+(e.y-t.y)*n,this.z=t.z+(e.z-t.z)*n,this.w=t.w+(e.w-t.w)*n,this}equals(t){return t.x===this.x&&t.y===this.y&&t.z===this.z&&t.w===this.w}fromArray(t,e=0){return this.x=t[e],this.y=t[e+1],this.z=t[e+2],this.w=t[e+3],this}toArray(t=[],e=0){return t[e]=this.x,t[e+1]=this.y,t[e+2]=this.z,t[e+3]=this.w,t}fromBufferAttribute(t,e){return this.x=t.getX(e),this.y=t.getY(e),this.z=t.getZ(e),this.w=t.getW(e),this}random(){return this.x=Math.random(),this.y=Math.random(),this.z=Math.random(),this.w=Math.random(),this}*[Symbol.iterator](){yield this.x,yield this.y,yield this.z,yield this.w}}class uy extends Sr{constructor(t=1,e=1,n={}){super(),this.isRenderTarget=!0,this.width=t,this.height=e,this.depth=1,this.scissor=new Wa(0,0,t,e),this.scissorTest=!1,this.viewport=new Wa(0,0,t,e);const i={width:t,height:e,depth:1};n=Object.assign({generateMipmaps:!1,internalFormat:null,minFilter:Ga,depthBuffer:!0,stencilBuffer:!1,depthTexture:null,samples:0,count:1},n);const s=new hi(i,n.mapping,n.wrapS,n.wrapT,n.magFilter,n.minFilter,n.format,n.type,n.anisotropy,n.colorSpace);s.flipY=!1,s.generateMipmaps=n.generateMipmaps,s.internalFormat=n.internalFormat,this.textures=[];const o=n.count;for(let a=0;a<o;a++)this.textures[a]=s.clone(),this.textures[a].isRenderTargetTexture=!0;this.depthBuffer=n.depthBuffer,this.stencilBuffer=n.stencilBuffer,this.depthTexture=n.depthTexture,this.samples=n.samples}get texture(){return this.textures[0]}set texture(t){this.textures[0]=t}setSize(t,e,n=1){if(this.width!==t||this.height!==e||this.depth!==n){this.width=t,this.height=e,this.depth=n;for(let i=0,s=this.textures.length;i<s;i++)this.textures[i].image.width=t,this.textures[i].image.height=e,this.textures[i].image.depth=n;this.dispose()}this.viewport.set(0,0,t,e),this.scissor.set(0,0,t,e)}clone(){return new this.constructor().copy(this)}copy(t){this.width=t.width,this.height=t.height,this.depth=t.depth,this.scissor.copy(t.scissor),this.scissorTest=t.scissorTest,this.viewport.copy(t.viewport),this.textures.length=0;for(let n=0,i=t.textures.length;n<i;n++)this.textures[n]=t.textures[n].clone(),this.textures[n].isRenderTargetTexture=!0;const e=Object.assign({},t.texture.image);return this.texture.source=new of(e),this.depthBuffer=t.depthBuffer,this.stencilBuffer=t.stencilBuffer,t.depthTexture!==null&&(this.depthTexture=t.depthTexture.clone()),this.samples=t.samples,this}dispose(){this.dispatchEvent({type:"dispose"})}}class dy extends uy{constructor(t=1,e=1,n={}){super(t,e,n),this.isWebGLRenderTarget=!0}}class lc extends Er{constructor(t=1,e=1,n=1,i=1,s=1,o=1){super(),this.type="BoxGeometry",this.parameters={width:t,height:e,depth:n,widthSegments:i,heightSegments:s,depthSegments:o};const a=this;i=Math.floor(i),s=Math.floor(s),o=Math.floor(o);const l=[],c=[],h=[],u=[];let d=0,f=0;g("z","y","x",-1,-1,n,e,t,o,s,0),g("z","y","x",1,-1,n,e,-t,o,s,1),g("x","z","y",1,1,t,n,e,i,o,2),g("x","z","y",1,-1,t,n,-e,i,o,3),g("x","y","z",1,-1,t,e,n,i,s,4),g("x","y","z",-1,-1,t,e,-n,i,s,5),this.setIndex(l),this.setAttribute("position",new Ia(c,3)),this.setAttribute("normal",new Ia(h,3)),this.setAttribute("uv",new Ia(u,2));function g(_,p,m,S,x,b,R,A,w,I,X){const y=b/w,T=R/I,j=b/2,q=R/2,L=A/2,V=w+1,O=I+1;let J=0,G=0;const $=new K;for(let Z=0;Z<O;Z++){const st=Z*T-q;for(let ft=0;ft<V;ft++){const Tt=ft*y-j;$[_]=Tt*S,$[p]=st*x,$[m]=L,c.push($.x,$.y,$.z),$[_]=0,$[p]=0,$[m]=A>0?1:-1,h.push($.x,$.y,$.z),u.push(ft/w),u.push(1-Z/I),J+=1}}for(let Z=0;Z<I;Z++)for(let st=0;st<w;st++){const ft=d+st+V*Z,Tt=d+st+V*(Z+1),W=d+(st+1)+V*(Z+1),it=d+(st+1)+V*Z;l.push(ft,Tt,it),l.push(Tt,W,it),G+=6}a.addGroup(f,G,X),f+=G,d+=J}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new lc(t.width,t.height,t.depth,t.widthSegments,t.heightSegments,t.depthSegments)}}const Cs=4,Vu=[.125,.215,.35,.446,.526,.582],Fi=20,gl=new ny,Gu=new Ar;let _l=null,xl=0,vl=0;const Li=(1+Math.sqrt(5))/2,ys=1/Li,Wu=[new K(1,1,1),new K(-1,1,1),new K(1,1,-1),new K(-1,1,-1),new K(0,Li,ys),new K(0,Li,-ys),new K(ys,0,Li),new K(-ys,0,Li),new K(Li,ys,0),new K(-Li,ys,0)];class fy{constructor(t){this._renderer=t,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._lodPlanes=[],this._sizeLods=[],this._sigmas=[],this._blurMaterial=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._compileMaterial(this._blurMaterial)}fromScene(t,e=0,n=.1,i=100){_l=this._renderer.getRenderTarget(),xl=this._renderer.getActiveCubeFace(),vl=this._renderer.getActiveMipmapLevel(),this._setSize(256);const s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(t,n,i,s),e>0&&this._blur(s,0,0,e),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(t,e=null){return this._fromTexture(t,e)}fromCubemap(t,e=null){return this._fromTexture(t,e)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=qu(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Yu(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose()}_setSize(t){this._lodMax=Math.floor(Math.log2(t)),this._cubeSize=Math.pow(2,this._lodMax)}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let t=0;t<this._lodPlanes.length;t++)this._lodPlanes[t].dispose()}_cleanup(t){this._renderer.setRenderTarget(_l,xl,vl),t.scissorTest=!1,Ea(t,0,0,t.width,t.height)}_fromTexture(t,e){t.mapping===du||t.mapping===fu?this._setSize(t.image.length===0?16:t.image[0].width||t.image[0].image.width):this._setSize(t.image.width/4),_l=this._renderer.getRenderTarget(),xl=this._renderer.getActiveCubeFace(),vl=this._renderer.getActiveMipmapLevel();const n=e||this._allocateTargets();return this._textureToCubeUV(t,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){const t=3*Math.max(this._cubeSize,112),e=4*this._cubeSize,n={magFilter:Ga,minFilter:Ga,generateMipmaps:!1,type:Uv,format:Jd,colorSpace:eo,depthBuffer:!1},i=Xu(t,e,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==t||this._pingPongRenderTarget.height!==e){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Xu(t,e,n);const{_lodMax:s}=this;({sizeLods:this._sizeLods,lodPlanes:this._lodPlanes,sigmas:this._sigmas}=py(s)),this._blurMaterial=my(s,t,e)}return i}_compileMaterial(t){const e=new Sa(this._lodPlanes[0],t);this._renderer.compile(e,gl)}_sceneToCubeUV(t,e,n,i){const a=new iy(90,1,e,n),l=[1,-1,1,1,1,1],c=[1,1,1,-1,-1,-1],h=this._renderer,u=h.autoClear,d=h.toneMapping;h.getClearColor(Gu),h.toneMapping=Pv,h.autoClear=!1;const f=new rf({name:"PMREM.Background",side:Zd,depthWrite:!1,depthTest:!1}),g=new Sa(new lc,f);let _=!1;const p=t.background;p?p.isColor&&(f.color.copy(p),t.background=null,_=!0):(f.color.copy(Gu),_=!0);for(let m=0;m<6;m++){const S=m%3;S===0?(a.up.set(0,l[m],0),a.lookAt(c[m],0,0)):S===1?(a.up.set(0,0,l[m]),a.lookAt(0,c[m],0)):(a.up.set(0,l[m],0),a.lookAt(0,0,c[m]));const x=this._cubeSize;Ea(i,S*x,m>2?x:0,x,x),h.setRenderTarget(i),_&&h.render(g,a),h.render(t,a)}g.geometry.dispose(),g.material.dispose(),h.toneMapping=d,h.autoClear=u,t.background=p}_textureToCubeUV(t,e){const n=this._renderer,i=t.mapping===du||t.mapping===fu;i?(this._cubemapMaterial===null&&(this._cubemapMaterial=qu()),this._cubemapMaterial.uniforms.flipEnvMap.value=t.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Yu());const s=i?this._cubemapMaterial:this._equirectMaterial,o=new Sa(this._lodPlanes[0],s),a=s.uniforms;a.envMap.value=t;const l=this._cubeSize;Ea(e,0,0,3*l,2*l),n.setRenderTarget(e),n.render(o,gl)}_applyPMREM(t){const e=this._renderer,n=e.autoClear;e.autoClear=!1;for(let i=1;i<this._lodPlanes.length;i++){const s=Math.sqrt(this._sigmas[i]*this._sigmas[i]-this._sigmas[i-1]*this._sigmas[i-1]),o=Wu[(i-1)%Wu.length];this._blur(t,i-1,i,s,o)}e.autoClear=n}_blur(t,e,n,i,s){const o=this._pingPongRenderTarget;this._halfBlur(t,o,e,n,i,"latitudinal",s),this._halfBlur(o,t,n,n,i,"longitudinal",s)}_halfBlur(t,e,n,i,s,o,a){const l=this._renderer,c=this._blurMaterial;o!=="latitudinal"&&o!=="longitudinal"&&console.error("blur direction must be either latitudinal or longitudinal!");const h=3,u=new Sa(this._lodPlanes[i],c),d=c.uniforms,f=this._sizeLods[n]-1,g=isFinite(s)?Math.PI/(2*f):2*Math.PI/(2*Fi-1),_=s/g,p=isFinite(s)?1+Math.floor(h*_):Fi;p>Fi&&console.warn(`sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${Fi}`);const m=[];let S=0;for(let w=0;w<Fi;++w){const I=w/_,X=Math.exp(-I*I/2);m.push(X),w===0?S+=X:w<p&&(S+=2*X)}for(let w=0;w<m.length;w++)m[w]=m[w]/S;d.envMap.value=t.texture,d.samples.value=p,d.weights.value=m,d.latitudinal.value=o==="latitudinal",a&&(d.poleAxis.value=a);const{_lodMax:x}=this;d.dTheta.value=g,d.mipInt.value=x-n;const b=this._sizeLods[i],R=3*b*(i>x-Cs?i-x+Cs:0),A=4*(this._cubeSize-b);Ea(e,R,A,3*b,2*b),l.setRenderTarget(e),l.render(u,gl)}}function py(r){const t=[],e=[],n=[];let i=r;const s=r-Cs+1+Vu.length;for(let o=0;o<s;o++){const a=Math.pow(2,i);e.push(a);let l=1/a;o>r-Cs?l=Vu[o-r+Cs-1]:o===0&&(l=0),n.push(l);const c=1/(a-2),h=-c,u=1+c,d=[h,h,u,h,u,u,h,h,u,u,h,u],f=6,g=6,_=3,p=2,m=1,S=new Float32Array(_*g*f),x=new Float32Array(p*g*f),b=new Float32Array(m*g*f);for(let A=0;A<f;A++){const w=A%3*2/3-1,I=A>2?0:-1,X=[w,I,0,w+2/3,I,0,w+2/3,I+1,0,w,I,0,w+2/3,I+1,0,w,I+1,0];S.set(X,_*g*A),x.set(d,p*g*A);const y=[A,A,A,A,A,A];b.set(y,m*g*A)}const R=new Er;R.setAttribute("position",new Bn(S,_)),R.setAttribute("uv",new Bn(x,p)),R.setAttribute("faceIndex",new Bn(b,m)),t.push(R),i>Cs&&i--}return{lodPlanes:t,sizeLods:e,sigmas:n}}function Xu(r,t,e){const n=new dy(r,t,e);return n.texture.mapping=Lv,n.texture.name="PMREM.cubeUv",n.scissorTest=!0,n}function Ea(r,t,e,n,i){r.viewport.set(t,e,n,i),r.scissor.set(t,e,n,i)}function my(r,t,e){const n=new Float32Array(Fi),i=new K(0,1,0);return new oc({name:"SphericalGaussianBlur",defines:{n:Fi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ac,depthTest:!1,depthWrite:!1})}function Yu(){return new oc({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:cc(),fragmentShader:`
		...
		`,blending:ac,depthTest:!1,depthWrite:!1})}function qu(){return new oc({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:cc(),fragmentShader:`
...
</div>`,Cy=function(t,e){var n=t[e];return et.isArray(arguments[2])||et.isObject(arguments[2])?new My(t,e,arguments[2]):et.isNumber(n)?et.isNumber(arguments[2])&&et.isNumber(arguments[3])?et.isNumber(arguments[4])?new zl(t,e,arguments[2],arguments[3],arguments[4]):new zl(t,e,arguments[2],arguments[3]):et.isNumber(arguments[4])?new Ya(t,e,{min:arguments[2],max:arguments[3],step:arguments[4]}):new Ya(t,e,{min:arguments[2],max:arguments[3]}):et.isString(n)?new by(t,e):et.isFunction(n)?new uf(t,e,""):et.isBoolean(n)?new cf(t,e):null};function Ry(r){setTimeout(r,1e3/60)}var Py=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||Ry,Ly=function(){function r(){fn(this,r),this.backgroundElement=document.createElement("div"),et.extend(this.backgroundElement.style,{backgroundColor:"rgba(0,0,0,0.8)",top:0,left:0,display:"none",zIndex:"1000",opacity:0,WebkitTransition:"opacity 0.2s linear",transition:"opacity 0.2s linear"}),z.makeFullscreen(this.backgroundElement),this.backgroundElement.style.position="fixed",this.domElement=document.createElement("div"),et.extend(this.domElement.style,{position:"fixed",display:"none",zIndex:"1001",opacity:0,WebkitTransition:"-webkit-transform 0.2s ease-out, opacity 0.2s linear",transition:"transform 0.2s ease-out, opacity 0.2s linear"}),document.body.appendChild(this.backgroundElement),document.body.appendChild(this.domElement);var t=this;z.bind(this.backgroundElement,"click",function(){t.hide()})}return pn(r,[{key:"show",value:function(){var e=this;this.backgroundElement.style.display="block",this.domElement.style.display="block",this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)",this.layout(),et.defer(function(){e.backgroundElement.style.opacity=1,e.domElement.style.opacity=1,e.domElement.style.webkitTransform="scale(1)"})}},{key:"hide",value:function(){var e=this,n=function i(){e.domElement.style.display="none",e.backgroundElement.style.display="none",z.unbind(e.domElement,"webkitTransitionEnd",i),z.unbind(e.domElement,"transitionend",i),z.unbind(e.domElement,"oTransitionEnd",i)};z.bind(this.domElement,"webkitTransitionEnd",n),z.bind(this.domElement,"transitionend",n),z.bind(this.domElement,"oTransitionEnd",n),this.backgroundElement.style.opacity=0,this.domElement.style.opacity=0,this.domElement.style.webkitTransform="scale(1.1)"}},{key:"layout",value:function(){this.domElement.style.left=window.innerWidth/2-z.getWidth(this.domElement)/2+"px",this.domElement.style.top=window.innerHeight/2-z.getHeight(this.domElement)/2+"px"}}]),r}(),Dy=gy(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`);Ay.inject(Dy);var Qu="dg",td=72,ed=20,_r="Default",rr=function(){try{return!!window.localStorage}catch{return!1}}(),ur=void 0,nd=!0,ws=void 0,yl=!1,df=[],ie=function r(t){var e=this,n=t||{};this.domElement=document.createElement("div"),this.__ul=document.createElement("ul"),this.domElement.appendChild(this.__ul),z.addClass(this.domElement,Qu),this.__folders={},this.__controllers=[],this.__rememberedObjects=[],this.__rememberedObjectIndecesToControllers=[],this.__listening=[],n=et.defaults(n,{closeOnTop:!1,autoPlace:!0,width:r.DEFAULT_WIDTH}),n=et.defaults(n,{resizable:n.autoPlace,hideable:n.autoPlace}),et.isUndefined(n.load)?n.load={preset:_r}:n.preset&&(n.load.preset=n.preset),et.isUndefined(n.parent)&&n.hideable&&df.push(this),n.resizable=et.isUndefined(n.parent)&&n.resizable,n.autoPlace&&et.isUndefined(n.scrollable)&&(n.scrollable=!0);var i=rr&&localStorage.getItem(Es(this,"isLocal"))==="true",s=void 0,o=void 0;if(Object.defineProperties(this,{parent:{get:function(){return n.parent}},scrollable:{get:function(){return n.scrollable}},autoPlace:{get:function(){return n.autoPlace}},closeOnTop:{get:function(){return n.closeOnTop}},preset:{get:function(){return e.parent?e.getRoot().preset:n.load.preset},set:function(d){e.parent?e.getRoot().preset=d:n.load.preset=d,Ny(this),e.revert()}},width:{get:function(){return n.width},set:function(d){n.width=d,Vl(e,d)}},name:{get:function(){return n.name},set:function(d){n.name=d,o&&(o.innerHTML=n.name)}},closed:{get:function(){return n.closed},set:function(d){n.closed=d,n.closed?z.addClass(e.__ul,r.CLASS_CLOSED):z.removeClass(e.__ul,r.CLASS_CLOSED),this.onResize(),e.__closeButton&&(e.__closeButton.innerHTML=d?r.TEXT_OPEN:r.TEXT_CLOSED)}},load:{get:function(){return n.load}},useLocalStorage:{get:function(){return i},set:function(d){rr&&(i=d,d?z.bind(window,"unload",s):z.unbind(window,"unload",s),localStorage.setItem(Es(e,"isLocal"),d))}}}),et.isUndefined(n.parent)){if(this.closed=n.closed||!1,z.addClass(this.domElement,r.CLASS_MAIN),z.makeSelectable(this.domElement,!1),rr&&i){e.useLocalStorage=!0;var a=localStorage.getItem(Es(this,"gui"));a&&(n.load=JSON.parse(a))}this.__closeButton=document.createElement("div"),this.__closeButton.innerHTML=r.TEXT_CLOSED,z.addClass(this.__closeButton,r.CLASS_CLOSE_BUTTON),n.closeOnTop?(z.addClass(this.__closeButton,r.CLASS_CLOSE_TOP),this.domElement.insertBefore(this.__closeButton,this.domElement.childNodes[0])):(z.addClass(this.__closeButton,r.CLASS_CLOSE_BOTTOM),this.domElement.appendChild(this.__closeButton)),z.bind(this.__closeButton,"click",function(){e.closed=!e.closed})}else{n.closed===void 0&&(n.closed=!0);var l=document.createTextNode(n.name);z.addClass(l,"controller-name"),o=dc(e,l);var c=function(d){return d.preventDefault(),e.closed=!e.closed,!1};z.addClass(this.__ul,r.CLASS_CLOSED),z.addClass(o,"title"),z.bind(o,"click",c),n.closed||(this.closed=!1)}n.autoPlace&&(et.isUndefined(n.parent)&&(nd&&(ws=document.createElement("div"),z.addClass(ws,Qu),z.addClass(ws,r.CLASS_AUTO_PLACE_CONTAINER),document.body.appendChild(ws),nd=!1),ws.appendChild(this.domElement),z.addClass(this.domElement,r.CLASS_AUTO_PLACE)),this.parent||Vl(e,n.width)),this.__resizeHandler=function(){e.onResizeDebounced()},z.bind(window,"resize",this.__resizeHandler),z.bind(this.__ul,"webkitTransitionEnd",this.__resizeHandler),z.bind(this.__ul,"transitionend",this.__resizeHandler),z.bind(this.__ul,"oTransitionEnd",this.__resizeHandler),this.onResize(),n.resizable&&Uy(this),s=function(){rr&&localStorage.getItem(Es(e,"isLocal"))==="true"&&localStorage.setItem(Es(e,"gui"),JSON.stringify(e.getSaveObject()))},this.saveToLocalStorageIfPossible=s;function h(){var u=e.getRoot();u.width+=1,et.defer(function(){u.width-=1})}n.parent||h()};ie.toggleHide=function(){yl=!yl,et.each(df,function(r){r.domElement.style.display=yl?"none":""})};ie.CLASS_AUTO_PLACE="a";ie.CLASS_AUTO_PLACE_CONTAINER="ac";ie.CLASS_MAIN="main";ie.CLASS_CONTROLLER_ROW="cr";ie.CLASS_TOO_TALL="taller-than-window";ie.CLASS_CLOSED="closed";ie.CLASS_CLOSE_BUTTON="close-button";ie.CLASS_CLOSE_TOP="close-top";ie.CLASS_CLOSE_BOTTOM="close-bottom";ie.CLASS_DRAG="drag";ie.DEFAULT_WIDTH=245;ie.TEXT_CLOSED="Close Controls";ie.TEXT_OPEN="Open Controls";ie._keydownHandler=function(r){document.activeElement.type!=="text"&&(r.which===td||r.keyCode===td)&&ie.toggleHide()};z.bind(window,"keydown",ie._keydownHandler,!1);et.extend(ie.prototype,{add:function(t,e){return dr(this,t,e,{factoryArgs:Array.prototype.slice.call(arguments,2)})},addColor:function(t,e){return dr(this,t,e,{color:!0})},remove:function(t){this.__ul.removeChild(t.__li),this.__controllers.splice(this.__controllers.indexOf(t),1);var e=this;et.defer(function(){e.onResize()})},destroy:function(){if(this.parent)throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead.");this.autoPlace&&ws.removeChild(this.domElement);var t=this;et.each(this.__folders,function(e){t.removeFolder(e)}),z.unbind(window,"keydown",ie._keydownHandler,!1),id(this)},addFolder:function(t){if(this.__folders[t]!==void 0)throw new Error('You already have a folder in this GUI by the name "'+t+'"');var e={name:t,parent:this};e.autoPlace=this.autoPlace,this.load&&this.load.folders&&this.load.folders[t]&&(e.closed=this.load.folders[t].closed,e.load=this.load.folders[t]);var n=new ie(e);this.__folders[t]=n;var i=dc(this,n.domElement);return z.addClass(i,"folder"),n},removeFolder:function(t){this.__ul.removeChild(t.domElement.parentElement),delete this.__folders[t.name],this.load&&this.load.folders&&this.load.folders[t.name]&&delete this.load.folders[t.name],id(t);var e=this;et.each(t.__folders,function(n){t.removeFolder(n)}),et.defer(function(){e.onResize()})},open:function(){this.closed=!1},close:function(){this.closed=!0},hide:function(){this.domElement.style.display="none"},show:function(){this.domElement.style.display=""},onResize:function(){var t=this.getRoot();if(t.scrollable){var e=z.getOffset(t.__ul).top,n=0;et.each(t.__ul.childNodes,function(i){t.autoPlace&&i===t.__save_row||(n+=z.getHeight(i))}),window.innerHeight-e-ed<n?(z.addClass(t.domElement,ie.CLASS_TOO_TALL),t.__ul.style.height=window.innerHeight-e-ed+"px"):(z.removeClass(t.domElement,ie.CLASS_TOO_TALL),t.__ul.style.height="auto")}t.__resize_handle&&et.defer(function(){t.__resize_handle.style.height=t.__ul.offsetHeight+"px"}),t.__closeButton&&(t.__closeButton.style.width=t.width+"px")},onResizeDebounced:et.debounce(function(){this.onResize()},50),remember:function(){if(et.isUndefined(ur)&&(ur=new Ly,ur.domElement.innerHTML=Ty),this.parent)throw new Error("You can only call remember on a top level GUI.");var t=this;et.each(Array.prototype.slice.call(arguments),function(e){t.__rememberedObjects.length===0&&Fy(t),t.__rememberedObjects.indexOf(e)===-1&&t.__rememberedObjects.push(e)}),this.autoPlace&&Vl(this,this.width)},getRoot:function(){for(var t=this;t.parent;)t=t.parent;return t},getSaveObject:function(){var t=this.load;return t.closed=this.closed,this.__rememberedObjects.length>0&&(t.preset=this.preset,t.remembered||(t.remembered={}),t.remembered[this.preset]=Ta(this)),t.folders={},et.each(this.__folders,function(e,n){t.folders[n]=e.getSaveObject()}),t},save:function(){this.load.remembered||(this.load.remembered={}),this.load.remembered[this.preset]=Ta(this),kl(this,!1),this.saveToLocalStorageIfPossible()},saveAs:function(t){this.load.remembered||(this.load.remembered={},this.load.remembered[_r]=Ta(this,!0)),this.load.remembered[t]=Ta(this),this.preset=t,Hl(this,t,!0),this.saveToLocalStorageIfPossible()},revert:function(t){et.each(this.__controllers,function(e){this.getRoot().load.remembered?ff(t||this.getRoot(),e):e.setValue(e.initialValue),e.__onFinishChange&&e.__onFinishChange.call(e,e.getValue())},this),et.each(this.__folders,function(e){e.revert(e)}),t||kl(this.getRoot(),!1)},listen:function(t){var e=this.__listening.length===0;this.__listening.push(t),e&&pf(this.__listening)},updateDisplay:function(){et.each(this.__controllers,function(t){t.updateDisplay()}),et.each(this.__folders,function(t){t.updateDisplay()})}});function dc(r,t,e){var n=document.createElement("li");return t&&n.appendChild(t),e?r.__ul.insertBefore(n,e):r.__ul.appendChild(n),r.onResize(),n}function id(r){z.unbind(window,"resize",r.__resizeHandler),r.saveToLocalStorageIfPossible&&z.unbind(window,"unload",r.saveToLocalStorageIfPossible)}function kl(r,t){var e=r.__preset_select[r.__preset_select.selectedIndex];t?e.innerHTML=e.value+"*":e.innerHTML=e.value}function Iy(r,t,e){if(e.__li=t,e.__gui=r,et.extend(e,{options:function(o){if(arguments.length>1){var a=e.__li.nextElementSibling;return e.remove(),dr(r,e.object,e.property,{before:a,factoryArgs:[et.toArray(arguments)]})}if(et.isArray(o)||et.isObject(o)){var l=e.__li.nextElementSibling;return e.remove(),dr(r,e.object,e.property,{before:l,factoryArgs:[o]})}},name:function(o){return e.__li.firstElementChild.firstElementChild.innerHTML=o,e},listen:function(){return e.__gui.listen(e),e},remove:function(){return e.__gui.remove(e),e}}),e instanceof zl){var n=new Ya(e.object,e.property,{min:e.__min,max:e.__max,step:e.__step});et.each(["updateDisplay","onChange","onFinishChange","step","min","max"],function(s){var o=e[s],a=n[s];e[s]=n[s]=function(){var l=Array.prototype.slice.call(arguments);return a.apply(n,l),o.apply(e,l)}}),z.addClass(t,"has-slider"),e.domElement.insertBefore(n.domElement,e.domElement.firstElementChild)}else if(e instanceof Ya){var i=function(o){if(et.isNumber(e.__min)&&et.isNumber(e.__max)){var a=e.__li.firstElementChild.firstElementChild.innerHTML,l=e.__gui.__listening.indexOf(e)>-1;e.remove();var c=dr(r,e.object,e.property,{before:e.__li.nextElementSibling,factoryArgs:[e.__min,e.__max,e.__step]});return c.name(a),l&&c.listen(),c}return o};e.min=et.compose(i,e.min),e.max=et.compose(i,e.max)}else e instanceof cf?(z.bind(t,"click",function(){z.fakeEvent(e.__checkbox,"click")}),z.bind(e.__checkbox,"click",function(s){s.stopPropagation()})):e instanceof uf?(z.bind(t,"click",function(){z.fakeEvent(e.__button,"click")}),z.bind(t,"mouseover",function(){z.addClass(e.__button,"hover")}),z.bind(t,"mouseout",function(){z.removeClass(e.__button,"hover")})):e instanceof Bl&&(z.addClass(t,"color"),e.updateDisplay=et.compose(function(s){return t.style.borderLeftColor=e.__color.toString(),s},e.updateDisplay),e.updateDisplay());e.setValue=et.compose(function(s){return r.getRoot().__preset_select&&e.isModified()&&kl(r.getRoot(),!0),s},e.setValue)}function ff(r,t){var e=r.getRoot(),n=e.__rememberedObjects.indexOf(t.object);if(n!==-1){var i=e.__rememberedObjectIndecesToControllers[n];if(i===void 0&&(i={},e.__rememberedObjectIndecesToControllers[n]=i),i[t.property]=t,e.load&&e.load.remembered){var s=e.load.remembered,o=void 0;if(s[r.preset])o=s[r.preset];else if(s[_r])o=s[_r];else return;if(o[n]&&o[n][t.property]!==void 0){var a=o[n][t.property];t.initialValue=a,t.setValue(a)}}}}function dr(r,t,e,n){if(t[e]===void 0)throw new Error('Object "'+t+'" has no property "'+e+'"');var i=void 0;if(n.color)i=new Bl(t,e);else{var s=[t,e].concat(n.factoryArgs);i=Cy.apply(r,s)}n.before instanceof Vi&&(n.before=n.before.__li),ff(r,i),z.addClass(i.domElement,"c");var o=document.createElement("span");z.addClass(o,"property-name"),o.innerHTML=i.property;var a=document.createElement("div");a.appendChild(o),a.appendChild(i.domElement);var l=dc(r,a,n.before);return z.addClass(l,ie.CLASS_CONTROLLER_ROW),i instanceof Bl?z.addClass(l,"color"):z.addClass(l,xy(i.getValue())),Iy(r,l,i),r.__controllers.push(i),i}function Es(r,t){return document.location.href+"."+t}function Hl(r,t,e){var n=document.createElement("option");n.innerHTML=t,n.value=t,r.__preset_select.appendChild(n),e&&(r.__preset_select.selectedIndex=r.__preset_select.length-1)}function sd(r,t){t.style.display=r.useLocalStorage?"block":"none"}function Fy(r){var t=r.__save_row=document.createElement("li");z.addClass(r.domElement,"has-save"),r.__ul.insertBefore(t,r.__ul.firstChild),z.addClass(t,"save-row");var e=document.createElement("span");e.innerHTML="&nbsp;",z.addClass(e,"button gears");var n=document.createElement("span");n.innerHTML="Save",z.addClass(n,"button"),z.addClass(n,"save");var i=document.createElement("span");i.innerHTML="New",z.addClass(i,"button"),z.addClass(i,"save-as");var s=document.createElement("span");s.innerHTML="Revert",z.addClass(s,"button"),z.addClass(s,"revert");var o=r.__preset_select=document.createElement("select");if(r.load&&r.load.remembered?et.each(r.load.remembered,function(u,d){Hl(r,d,d===r.preset)}):Hl(r,_r,!1),z.bind(o,"change",function(){for(var u=0;u<r.__preset_select.length;u++)r.__preset_select[u].innerHTML=r.__preset_select[u].value;r.preset=this.value}),t.appendChild(o),t.appendChild(e),t.appendChild(n),t.appendChild(i),t.appendChild(s),rr){var a=document.getElementById("dg-local-explain"),l=document.getElementById("dg-local-storage"),c=document.getElementById("dg-save-locally");c.style.display="block",localStorage.getItem(Es(r,"isLocal"))==="true"&&l.setAttribute("checked","checked"),sd(r,a),z.bind(l,"change",function(){r.useLocalStorage=!r.useLocalStorage,sd(r,a)})}var h=document.getElementById("dg-new-constructor");z.bind(h,"keydown",function(u){u.metaKey&&(u.which===67||u.keyCode===67)&&ur.hide()}),z.bind(e,"click",function(){h.innerHTML=JSON.stringify(r.getSaveObject(),void 0,2),ur.show(),h.focus(),h.select()}),z.bind(n,"click",function(){r.save()}),z.bind(i,"click",function(){var u=prompt("Enter a new preset name.");u&&r.saveAs(u)}),z.bind(s,"click",function(){r.revert()})}function Uy(r){var t=void 0;r.__resize_handle=document.createElement("div"),et.extend(r.__resize_handle.style,{width:"6px",marginLeft:"-3px",height:"200px",cursor:"ew-resize",position:"absolute"});function e(s){return s.preventDefault(),r.width+=t-s.clientX,r.onResize(),t=s.clientX,!1}function n(){z.removeClass(r.__closeButton,ie.CLASS_DRAG),z.unbind(window,"mousemove",e),z.unbind(window,"mouseup",n)}function i(s){return s.preventDefault(),t=s.clientX,z.addClass(r.__closeButton,ie.CLASS_DRAG),z.bind(window,"mousemove",e),z.bind(window,"mouseup",n),!1}z.bind(r.__resize_handle,"mousedown",i),z.bind(r.__closeButton,"mousedown",i),r.domElement.insertBefore(r.__resize_handle,r.domElement.firstElementChild)}function Vl(r,t){r.domElement.style.width=t+"px",r.__save_row&&r.autoPlace&&(r.__save_row.style.width=t+"px"),r.__closeButton&&(r.__closeButton.style.width=t+"px")}function Ta(r,t){var e={};return et.each(r.__rememberedObjects,function(n,i){var s={},o=r.__rememberedObjectIndecesToControllers[i];et.each(o,function(a,l){s[l]=t?a.initialValue:a.getValue()}),e[i]=s}),e}function Ny(r){for(var t=0;t<r.__preset_select.length;t++)r.__preset_select[t].value===r.preset&&(r.__preset_select.selectedIndex=t)}function pf(r){r.length!==0&&Py.call(window,function(){pf(r)}),et.each(r,function(t){t.updateDisplay()})}var Oy=ie;const Fs={TrainFront:"TrainFront",TrainBack:"TrainBack",TrainSide:"TrainSide"},ti=400;class zy extends me{constructor(){super();const t=new Go;t.add(new Qt(new v(-2,.3,2),new v(-2,.3,2.5),new v(-2,.4,3))),t.add(new Qt(new v(-2,.4,3),new v(-2,1,5),new v(-2,5,6))),t.add(new Qt(new v(-2,5,6),new v(-2,6,6.2),new v(-2,6,7))),t.add(new Qt(new v(-2,6,7),new v(-2,6,7.5),new v(-2,5,8))),t.add(new Qt(new v(-2,5,8),new v(-2,3.75,8.625),new v(-2,2.5,9.25))),t.add(new Qt(new v(-2,2.5,9.25),new v(-2,2.1,9.5),new v(-2,2.1,9.8))),t.add(new Qt(new v(-2,2.1,9.8),new v(-2.1,2.1,10.3),new v(-1.7,2.08,10.5))),t.add(new Qt(new v(-1.7,2.08,10.5),new v(-.6,2.05,11.2),new v(-.4,2,9.8))),t.add(new Qt(new v(-.4,2,9.8),new v(-.3,1.9,8.9),new v(-1,1.7,8.7))),t.add(new Qt(new v(-1,1.7,8.7),new v(-1.8,1.5,8.6),new v(-1.5,1.6,9.7))),t.add(new Qt(new v(-1.5,1.6,9.7),new v(-.95,1.6,11.4),new v(0,1.4,9.9))),t.add(new Qt(new v(0,1.4,9.9),new v(.5,1.3,9.2),new v(.3,1.2,8))),t.add(new Ss(new v(.3,1.2,8),new v(-.2,1.1,6.3),new v(-2.3,1.1,8.2),new v(-4.2,1,6.5))),t.add(new Qt(new v(-4.2,1,6.5),new v(-4.9,.9,5.8),new v(-4.8,.6,4.8))),t.add(new Qt(new v(-4.8,.6,4.8),new v(-4.7,.25,3.1),new v(-4.8,1.8,2.7))),t.add(new Qt(new v(-4.8,1.8,2.7),new v(-4.9,3.2,2.4),new v(-5,3.3,3.6))),t.add(new Qt(new v(-5,3.3,3.6),new v(-5.1,3.35,4.6),new v(-5.3,2.3,4.9))),t.add(new Qt(new v(-5.3,2.3,4.9),new v(-5.5,1.25,5.2),new v(-5.3,.8,4.1))),t.add(new Qt(new v(-5.3,.8,4.1),new v(-5.2,.5,3.5),new v(-5.1,.5,3))),t.add(new Qt(new v(-5.1,.5,3),new v(-4.9,.45,2),new v(-4.8,.4,1))),t.add(new Qt(new v(-4.8,.4,1),new v(-4.3,.35,-2.2),new v(-3.3,.3,-2))),t.add(new Qt(new v(-3.3,.3,-2),new v(-2,.27,-1.5),new v(-2,.3,2))),t.closePath(),t.arcLengthDivisions=800,t.updateArcLengths();let e=t.computeFrenetFrames(ti,!0);this.railCurve=t,this.frenetFrames=e,this.rcMesh=this.createRailsMesh(t,e),this.createColumns(this.railCurve,1,e),this.add(this.rcMesh),this.scaledTunnel=this.buildScaledTunnel(),this.scaledTunnel.position.set(-4.8,.5,1.1),this.scaledTunnel.rotation.y=-Math.PI/20,this.scaledTunnel.rotation.x=-.045,this.add(this.scaledTunnel),this.twistedTunnel=this.buildTwistedTunnel(),this.twistedTunnel.position.set(.07,1.25,7.5),this.twistedTunnel.rotation.y=Math.PI/8,this.twistedTunnel.rotation.x=-.08,this.add(this.twistedTunnel),this.helpers={normals:[],tangents:[],binormals:[]},this.traverse(n=>{n.castShadow=!0})}addTrain(t){this.train=t,this.train.matrixAutoUpdate=!1,this.trainPosition=0,this.add(t),t.rotation.x=Math.PI,t.position.y+=-.09,this.trainSpeed=1,this.animate()}animate(){this.trainPosition+=this.trainSpeed;let t=this.railCurve.getSpacedPoints(8*ti);this.trainPosition>8*ti&&(this.trainPosition=0);const e=this.frenetFrames,n=t[this.trainPosition],i=this.trainPosition/8;let s=e.normals[Math.floor(i)].clone(),o=e.binormals[Math.floor(i)].clone(),a=e.tangents[Math.floor(i)].clone();s.lerp(e.normals[Math.ceil(i)],i-Math.floor(i)),o.lerp(e.binormals[Math.ceil(i)],i-Math.floor(i)),a.lerp(e.tangents[Math.ceil(i)],i-Math.floor(i));let l=new $t;l.makeRotationX(Math.PI);let c=new $t;c.makeScale(.1,.1,.1);let h=new $t;h.set(s.x,o.x,a.x,n.x+.1*-o.x,s.y,o.y,a.y,n.y+.1*-o.y,s.z,o.z,a.z,n.z+.1*-o.z,0,0,0,1);let u=this.getObjectByName(Fs.TrainFront),d=this.getObjectByName(Fs.TrainBack),f=this.getObjectByName(Fs.TrainSide);u&&d&&f&&this.animateCameras(u,d,f,s,o,a,n),l.multiply(c),h.multiply(l),this.train.matrix=h}animateCameras(t,e,n,i,s,o,a){t.matrixAutoUpdate=!1,e.matrixAutoUpdate=!1,n.matrixAutoUpdate=!1;let l=new $t;l.makeRotationX(Math.PI);let c=new $t,h=c.clone(),u=c.clone();c.makeTranslation(0,.01,-.01),h.makeRotationZ(Math.PI),u.makeRotationFromEuler(new bn(-.65,Math.PI/2,Math.PI,"ZYX"));let d=new $t;d.set(i.x,s.x,o.x,a.x+.15*-s.x,i.y,s.y,o.y,a.y+.15*-s.y,i.z,s.z,o.z,a.z+.15*-s.z,0,0,0,1);let f=d.clone(),g=d.clone();d.multiply(l),d.multiply(c);let _=new $t,p=_.clone();_.makeTranslation(0,.025,-.08),p.makeTranslation(-.04,.005,.25),f.multiply(h),f.multiply(_),g.multiply(u),g.multiply(p),t.matrix=d,e.matrix=f,n.matrix=g}wireframe(t){this.rcMesh.material.wireframe=t,this.rcMesh.material.needsUpdate=!0}flatShading(t){this.rcMesh.material.flatShading=t,this.rcMesh.material.needsUpdate=!0}drawComponents(t,e,n,i,s,o=!1){for(let a=0;a<t.length;a++){let l=new Nt;o&&l.set(1,0,0,0,0,0,0,0,1);const c=new v(t[a].x,t[a].y,t[a].z);c.applyMatrix3(l),c.normalize();const h=1,u=new wv(c,this.railCurve.getPointAt(a/(ti+1)),h,n);s.push(u),e.add(u)}}hideComponents(t,e){for(let n=0;n<t.length;n++)e.remove(t[n]);t.length=0}drawNormals(t){this.helpers.normals.length==0&&this.drawComponents(this.frenetFrames.normals,t,65280,this.railCurve,this.helpers.normals,!0)}hideNormals(t){this.hideComponents(this.helpers.normals,t)}drawTangents(t){this.helpers.tangents.length==0&&this.drawComponents(this.frenetFrames.tangents,t,16711680,this.railCurve,this.helpers.tangents)}hideTangents(t){this.hideComponents(this.helpers.tangents,t)}drawBinormals(t){this.helpers.binormals.length==0&&this.drawComponents(this.frenetFrames.binormals,t,255,this.railCurve,this.helpers.binormals)}hideBinormals(t){this.hideComponents(this.helpers.binormals,t)}getTrackShape(t){let e=new Go;e.autoClose=!1;const n=-.178,i=.16,s=1e-4;return e.add(new Qt(new v(-n-.178,i-.335,s),new v(-n-.158,i-.34,s),new v(-n-.135,i-.318,s))),e.add(new tn(new v(-n-.135,i-.318,s),new v(-n-.027,i-.188,s))),e.add(new Qt(new v(-n-.027,i-.188,s),new v(-n-.018,i-.18,s),new v(-n-.006,i-.173,s))),e.add(new tn(new v(-n-.006,i-.173,s),new v(-n+.017,i-.168,s))),e.add(new Ss(new v(-n+.017,i-.168,s),new v(-n+.028,i-.16,s),new v(-n+.028,i-.15,s),new v(-n+.028,i-.145,s))),e.add(new tn(new v(-n+.028,i-.145,s),new v(-n+.028,i-.03,s))),e.add(new Qt(new v(-n+.028,i-.03,s),new v(-n+.028,i,s),new v(-n+.01,i,s))),e.add(new tn(new v(-n+.01,i,s),new v(-n-.008,i,s))),e.add(new tn(new v(-n-.008,i,s),new v(-n-.008,i-.08,s))),e.add(new Ss(new v(-n-.008,i-.08,s),new v(-(n+.08),i-.08,s),new v(-(n+.11),i-.148,s),new v(-(n+.174),i-.148,s))),e.add(new Ss(new v(n+.184,i-.148,s),new v(n+.11,i-.148,s),new v(n+.08,i-.08,s),new v(n,i-.08,s))),e.add(new tn(new v(n,i-.08,s),new v(n,i,s))),e.add(new tn(new v(n,i,s),new v(n-.02,i,s))),e.add(new Qt(new v(n-.02,i,s),new v(n-.034,i,s),new v(n-.034,i-.03,s))),e.add(new tn(new v(n-.034,i-.03,s),new v(n-.034,i-.145,s))),e.add(new Ss(new v(n-.034,i-.145,s),new v(n-.034,i-.15,s),new v(n-.034,i-.16,s),new v(n-.02,i-.168,s))),e.add(new tn(new v(n-.02,i-.168,s),new v(n+.005,i-.173,s))),e.add(new Qt(new v(n+.005,i-.173,s),new v(n+.018,i-.18,s),new v(n+.024,i-.188,s))),e.add(new tn(new v(n+.024,i-.188,s),new v(n+.142,i-.318,s))),e.add(new Qt(new v(n+.142,i-.318,s),new v(n+.16,i-.335,s),new v(n+.178,i-.335,s))),e}createRailsMesh(t,e){let n=this.getTrackShape(),i=function(l,c,h){let u=new Nt;u.set(1,0,0,0,0,0,0,0,1);const d=new $t,f=new $t,g=new $t;f.makeScale(.5,.75,.75),g.makeRotationZ(Math.PI),h.copy(n.getPointAt(l));let _=t.getPointAt(c),p=Math.floor(ti*c);c==ti&&(p=0),h.applyMatrix4(f),h.applyMatrix4(g),e.normals[p].applyMatrix3(u),e.normals[p].normalize(),e.binormals[p].crossVectors(e.tangents[p],e.normals[p]),e.binormals[p].normalize(),d.set(e.normals[p].x,e.binormals[p].x,e.tangents[p].x,_.x,e.normals[p].y,e.binormals[p].y,e.tangents[p].y,_.y,e.normals[p].z,e.binormals[p].z,e.tangents[p].z,_.z,0,0,0,1),h.applyMatrix4(d)};const s=new vn(i,20,ti-1);s.computeVertexNormals();const o=new ve({color:16777215,flatShading:!1,wireframe:!1});return new ee(s,o)}removeInvalidRayIntersections(t,e){let n=[];for(let i=0;i<t.length;i++)t[i].distance<e&&n.push(t[i]);return n}createColumns(t,e,n){const s=new Va(0,0,.05,.05,0,2*Math.PI,!1),o=t.getSpacedPoints(ti);let a=o.map(function(h){let u=h.clone();return u.y=0,u}),l=0,c=0;for(let h=1;h<a.length;h++)if(l+=a[h-1].distanceTo(a[h]),c+=o[h-1].distanceTo(o[h]),l>=e){let u=l-e,d=c-e,f=a[h-1].lerp(a[h],u),g=o[h-1].lerp(o[h],d),_=n.normals[h-1].lerp(n.normals[h],d),p=n.tangents[h-1].lerp(n.tangents[h],d),m=n.binormals[h-1].lerp(n.binormals[h],d);const S=new yv;S.set(f,new v(0,1,0));const x=S.intersectObject(this.rcMesh);if(this.removeInvalidRayIntersections(x,g.y).length<=1&&m.y<0){let R=new Nt;R.set(1,0,0,0,0,0,0,0,1),_.applyMatrix3(R),_.normalize();const A=new ui;A.setFromAxisAngle(_,Math.PI/2*p.y),new $t().set(1-m.x*m.x,-m.x*m.y,-m.x*m.z,0,-m.x*m.y,1-m.y*m.y,-m.y*m.z,0,-m.x*m.z,-m.y*m.z,1-m.z*m.z,0,0,0,0,1),new $t().set(1,0,0,f.x,0,1,0,g.y,0,0,1,f.z,0,0,0,1);let X=g.y;for(let L=0;L<8;L++){let V=new v(f.x+Math.cos(Math.PI/4*L)*.05,0,f.y+Math.sin(Math.PI/4*L));S.set(V,new v(0,1,0));const O=this.removeInvalidRayIntersections(x,g.y);X>O[0].distance&&(X=O[0].distance)}let y=function(L,V,O){let J=new v(s.getPointAt(L).x,0,s.getPointAt(L).y);if(O.set(J.x,J.y,J.z),V<.1&&(p.y<-.55||p.y>.55)){let G=O.clone();G.applyQuaternion(A),O.y+=X+G.y+.1}else O.y+=g.y*(1-V);return O};const T=new vn(y,32,3);T.computeVertexNormals();const j=new ve({color:13882323,flatShading:!1,wireframe:!1}),q=new ee(T,j);q.name="Column",q.position.set(f.x,0,f.z),this.add(q)}l=0,c=0}}getAllColumns(){return this.getObjectsByProperty("name","Column")}buildScaledTunnel(){const e=new Va(0,0,.2,.2,0,2*Math.PI,!0,0),n=new $t;let i=new Go;i.add(new tn(new v(0,0,-.45),new v(0,0,.45)));let s=function(c,h,u){u.copy(e.getPointAt(c));let d=i.getPointAt(h);u.z=d.z;let f=.5*Math.abs(Math.cos(5*Math.PI*h))+1;n.makeScale(f,f,1),u.applyMatrix4(n)};const o=new vn(s,16,25),a=new ve({color:16777215,flatShading:!1,side:He});return new ee(o,a)}buildTwistedTunnel(){let t=function(s,o,a){const h=new $t;if(h.makeRotationZ(Math.PI*o),s<=.25){a.set(-.2375+1.9*s,-.2375,.85*o),a.applyMatrix4(h);return}if(s<=.5){a.set(.2375,-.2375+1.9*(s-.25),.85*o),a.applyMatrix4(h);return}if(s<=.75){a.set(.2375+(.5-s)*1.9,.2375,.85*o),a.applyMatrix4(h);return}a.set(-.2375,.2375+(.75-s)*1.9,.85*o),a.applyMatrix4(h)};const e=new vn(t,4,50),n=new ve({color:15569199,flatShading:!1,side:He});return new ee(e,n)}}class mf extends me{constructor(t,e,n=new v(0,0,0),i=16091904){super(),this.len=t,this.width=e;const s=.2,o=.2;let a={topA:new v(0,this.len,0),topB:new v(this.len*s,this.len,0),midB:new v(this.len*s,this.len*o,0),midC:new v(this.len,this.len*o,0),botC:new v(this.len,0,0),botA:new v(0,0,0)},l=function(g,_,p,m){return g<=1/6?(p.lerpVectors(a.topA,a.topB,g*6),p.z=_*m.width):g<=1/3?(p.lerpVectors(a.topB,a.midB,(g-1/6)/(1/3-1/6)),p.z=_*m.width):g<=1/2?(p.lerpVectors(a.midB,a.midC,(g-1/3)/(1/2-1/3)),p.z=_*m.width):g<=2/3?(p.lerpVectors(a.midC,a.botC,(g-1/2)/(2/3-1/2)),p.z=_*m.width):g<=5/6?(p.lerpVectors(a.botC,a.botA,(g-2/3)/(5/6-2/3)),p.z=_*m.width):(p.lerpVectors(a.botA,a.topA,(g-5/6)/(1-5/6)),p.z=_*m.width),p};const c=new vn((g,_,p)=>{l(g,_,p,this)},12,10);c.computeVertexNormals(),c.translate(n);const h=new ve({color:i,wireframe:!1,side:He}),u=new ee(c,h);n.clone();let d=this.buildCap(a,kn,n),f=this.buildCap(a,Fe,n);return f.position.z=this.width,u.add(d),u.add(f),u}buildCap(t,e,n){let i=new v,s=new v,o=function(h,u,d,f){return u<.5?(i.lerpVectors(t.topA,t.botA,u*2),s.lerpVectors(t.topB,t.midB,u*2),d.lerpVectors(i,s,h)):(i.lerpVectors(t.botA,t.botC,(u-.5)*2),s.lerpVectors(t.midB,t.midC,(u-.5)*2),d.lerpVectors(i,s,h)),d};const a=new vn((h,u,d)=>{o(h,u,d)},12,10);a.computeVertexNormals(),a.translate(n);const l=new ve({color:16091904,wireframe:!1,side:e});return new ee(a,l)}}class By extends me{constructor(){super();const t=32,e=.4,n=.25,i=.5,s=.25,o=.5,a=this.getPartsDrawingFunction(t,e,n,i,s,o,o),l=new vn(a,t,1),c=new ve({color:65297,flatShading:!1,wireframe:!1,side:He}),h=new ee(l,c);let u=h.clone();u.position.z=-e*2,u.rotation.y=Math.PI;const d=this.getPartsDrawingFunction(t,.8,n,s,i,0,0,!1),f=new vn(d,t,1),g=new ve({color:65297,flatShading:!1,wireframe:!1,side:He}),_=new ee(f,g);_.position.z=-e*2,_.rotation.z=Math.PI/2;const p=this.getCap(n/2,i/2,s/2,32),m=new ve({color:65297,flatShading:!1,wireframe:!1,side:He}),S=new ee(p,m),x=new ee(p,m);S.position.z=e,S.rotation.x=Math.PI/2,x.position.z=-e*3,x.rotation.x=-Math.PI/2;const b=new mf(.3,.5);b.position.z=-.45,b.position.y=.17,b.position.x=-.25,b.rotation.y=Math.PI/2;const R=b.clone();R.position.z=-.05,this.add(h),this.add(u),this.add(_),this.add(S),this.add(x),this.add(b),this.add(R)}getPartsDrawingFunction(t,e,n,i,s,o,a,l=!0){const c=(t-4)/4,h=1/t,u=new Nt;return function(f,g,_){f!=0&&f%.25==0?f==.25?(_.x=n*Math.cos(Math.PI/2)+i/2,_.y=n*Math.sin(Math.PI/2)+s/2):f==.5?(_.x=n*Math.cos(Math.PI)+i/2,_.y=n*Math.sin(Math.PI)+s/2):f==.75?(_.x=n*Math.cos(3*Math.PI/2)+i/2,_.y=n*Math.sin(3*Math.PI/2)+s/2):f==1&&(_.x=l?n+i/2:i/2+n,_.y=l?s/2:-s/2):f<=c*h?(_.x=n*Math.cos(Math.PI/2*f/(c*h))+i/2,_.y=n*Math.sin(Math.PI/2*f/(c*h))+s/2):f<.25&&f>c*h?(_.x=n*Math.cos(Math.PI/2*f/.25)+i/2,_.y=n*Math.sin(Math.PI/2*f/.25)+s/2):f>.25&&f<=.25+c*h?(_.x=n*Math.cos(Math.PI/2+Math.PI/2*(f-.25)/(c*h))+i/2,_.y=n*Math.sin(Math.PI/2+Math.PI/2*(f-.25)/(c*h))+s/2):f<.5&&f>.25+c*h?(_.x=n*Math.cos(Math.PI*f/.5)+i/2,_.y=n*Math.sin(Math.PI*f/.5)+s/2):f>.5&&f<=.5+c*h?(_.x=n*Math.cos(Math.PI+Math.PI/2*(f-.5)/(c*h))+i/2,_.y=n*Math.sin(Math.PI+Math.PI/2*(f-.5)/(c*h))+s/2):f<.75&&f>.5+c*h?(_.x=n*Math.cos(1.5*Math.PI*f/.75)+i/2,_.y=n*Math.sin(1.5*Math.PI*f/.75)+s/2):f>.75&&f<=.75+c*h?(_.x=n*Math.cos(1.5*Math.PI+Math.PI/2*(f-.75)/(c*h))+i/2,_.y=n*Math.sin(1.5*Math.PI+Math.PI/2*(f-.75)/(c*h))+s/2):(_.x=n*Math.cos(2*Math.PI*f)+i/2,_.y=n*Math.sin(2*Math.PI*f)+s/2),_.z=e*g,u.makeScale(1-o*g,1-a*g),f>=.25&&f<.5?_.x-=i:f>=.5&&f<.75?(_.x-=i,_.y-=s):f>=.75&&f<1&&(_.y-=s),g>0&&_.applyMatrix3(u)}}buildCap(t,e,n,i,s,o=!1){const l=2*Math.PI/(t.segments-4),c=(t.segments-4)/4;let h=t.positions,u=t.indices,d=t.normals,f=t.uvs;const g=0;h.push(0,n,0),d.push(0,1,0),f.push(1,1);let _=i/2,p=s/2,m=0,S=0;for(let A=0;A<=t.segments+2;A++){S==c+1&&(A/(c+1)==1&&(_-=i),A/(c+1)==2&&(p-=s),A/(c+1)==3&&(_+=i),A/(c+1)==4&&(p+=s),m++,S=0);const w=(A-m)*l,I=e*Math.cos(w)+_,X=e*Math.sin(w)+p;if(h.push(I,n,X),d.push(I,1,X),f.push(0,0),A<=t.segments+2){const y=g,T=g+A+1-m,j=g+A+2-m;u.push(y,j,T)}S++}const x=g,b=g+t.segments,R=1;o?u.push(x,b,R):u.push(x,R,b)}getCap(t,e,n,i){let s=new Ne;const o=[],a=[],l=[],c=[];return this.buildCap({positions:o,indices:a,normals:l,uvs:c,segments:i},t,0,e,n,!1),s.setAttribute("position",new Kt(o,3)),s.setAttribute("normal",new Kt(l,3)),s.setAttribute("uv",new Kt(c,2)),s.setIndex(a),s}}const rd="chair";class ky extends me{constructor(){super(),this.properties={segmentCount:25,baseBigRadius:.18,baseMidRadius:.13,baseLowRadius:.08,baseLength:.5,topWidth:1,topLength:.3,axisRadius:.08,axisLength:1,chainRad:.008,chainLen:.9,chairLen:.12,chairWid:.25,baseColor:3584762,axisColor:11184810,topColor:16091904,chainColor:1381653,stopTime:7500,runTime:2e4,acceleration:1e-4,maxspeed:.02},this.chairRotPosition=0,this.base=this.createBase(),this.axis=this.createAxis(),this.top=this.createTop(),this.chairs=[],this.add(this.base),this.add(this.axis),this.add(this.top);const t=10;for(let e=0;e<t;e++){let n=this.createChainChair();this.chairs.push(n),n.position.x=(this.properties.topWidth-.1)*Math.cos(2*Math.PI*(1-e/t)),n.position.z=-(this.properties.topWidth-.1)*Math.sin(2*Math.PI*(1-e/t)),n.getObjectByName(rd).rotation.y=Math.PI/2,n.position.y+=this.properties.chairLen,n.rotation.y=2*Math.PI*(1-e/t),this.top.add(n)}this.inStoppageTime=!0,this.stoppageTime=0,this.lastUpdateTime=0,this.currentAcceleration=-this.properties.acceleration,this.currentSpeed=0,this.runningTime=0,this.traverse(e=>{e.castShadow=!0})}createBase(){let t=this.properties,e=function(o,a,l,c){const h=c.baseBigRadius-c.baseMidRadius;a<=.6?(l.x=c.baseBigRadius*Math.cos(2*Math.PI*(1-o)),l.z=c.baseBigRadius*Math.sin(2*Math.PI*(1-o))):a<=.8?(l.x=(c.baseBigRadius-h*((a-.6)/.2))*Math.cos(2*Math.PI*(1-o)),l.z=(c.baseBigRadius-h*((a-.6)/.2))*Math.sin(2*Math.PI*(1-o))):a<=.95?(l.x=c.baseMidRadius*Math.cos(2*Math.PI*(1-o)),l.z=c.baseMidRadius*Math.sin(2*Math.PI*(1-o))):(l.x=c.baseLowRadius*Math.cos(2*Math.PI*(1-o))*(.1/(a-.9)),l.z=c.baseLowRadius*Math.sin(2*Math.PI*(1-o))*(.1/(a-.9))),l.y=c.baseLength*a};const n=new vn((o,a,l)=>{e(o,a,l,t)},this.properties.segmentCount,20),i=new ve({color:this.properties.baseColor});return new ee(n,i)}createAxis(){const t=new ks(this.properties.axisRadius,this.properties.axisRadius,this.properties.axisLength,this.properties.segmentCount,3,!0),e=new ve({color:this.properties.axisColor}),n=new ee(t,e);return n.position.y=this.properties.baseLength*2,n}createTop(){let t=function(s,o,a,l){const c=l.topWidth-l.baseLowRadius;o==0?(a.x=l.baseLowRadius*Math.cos(2*Math.PI*(1-s)),a.z=l.baseLowRadius*Math.sin(2*Math.PI*(1-s)),a.y=0):o<=.2?(a.x=(l.baseLowRadius+c*(o/.2))*Math.cos(2*Math.PI*(1-s)),a.z=(l.baseLowRadius+c*(o/.2))*Math.sin(2*Math.PI*(1-s)),a.y=l.topLength*(.1+o)):o<=.8?(a.x=l.topWidth*Math.cos(2*Math.PI*(1-s)),a.z=l.topWidth*Math.sin(2*Math.PI*(1-s)),a.y=l.topLength*(.1+o)):(a.x=0,a.z=0,a.y=l.topLength*1.5)};const e=new vn((s,o,a)=>{t(s,o,a,this.properties)},this.properties.segmentCount,10);e.computeVertexNormals();const n=new ve({color:this.properties.topColor,wireframe:!1}),i=new ee(e,n);return i.position.y=this.properties.axisLength+this.properties.baseLength,i}createChainChair(){const t=new ks(this.properties.chainRad,this.properties.chainRad,this.properties.chainLen,32);t.translate(0,-this.properties.chainLen/2,0);const e=new ve({color:this.properties.chainColor}),n=new ee(t,e);let i=new mf(this.properties.chairLen,this.properties.chairWid,new v(this.properties.chainRad,-(this.properties.chainLen+this.properties.chairLen),-this.properties.chairWid/2));return i.name=rd,n.add(i),n}calcularTheta(t,e=1e-6,n=1e3){let i=.1,s=0;const o=9.8,a=this.properties.topWidth-.1,l=this.properties.chainLen,c=t*80;for(;s<n;){let h=Math.tan(i)-c**2*(a+l*Math.sin(i))/o,u=(1/Math.cos(i))**2-c**2*l*Math.cos(i)/o,d=i-h/u;if(Math.abs(d-i)<e)return d;i=d,s++}throw new Error("No convergió después de "+n+" iteraciones.")}animate(){}}class no extends ee{constructor(){const t=no.SkyShader,e=new Hn({name:t.name,uniforms:Od.clone(t.uniforms),vertexShader:t.vertexShader,fragmentShader:t.fragmentShader,side:Fe,depthWrite:!1});super(new Ja(1,1,1),e),this.isSky=!0}}no.SkyShader={name:"SkyShader",uniforms:{turbidity:{value:2},rayleigh:{value:1},mieCoefficient:{value:.005},mieDirectionalG:{value:.8},sunPosition:{value:new v},up:{value:new v(0,1,0)}},vertexShader:`
    ...
    `,qt={tierra:{url:"tierra.jpg",object:null},roca:{url:"ripio.jpg",object:null},pasto:{url:"pasto.jpg",object:null},sendero:{url:"trail.jpg",object:null},rust:{url:"column_base.jpg",object:null},rust_norm:{url:"column_normals.jpg",object:null},rust_rough:{url:"column_rough.jpg",object:null},rust_metal:{url:"column_metal.jpg",object:null},rust_ao:{url:"column_ao.jpg",object:null},twist_tunnel:{url:"tunnelA_base.png",object:null},twist_tunnel_alpha:{url:"tunnelA_alpha.png",object:null},twist_tunnel_norm:{url:"tunnelA_normals.png",object:null},rail:{url:"rail_base.jpg",object:null},rail_ao:{url:"rail_ao.jpg",object:null},rail_norm:{url:"rail_normal.jpg",object:null},chtop:{url:"chairsTop_base.png",object:null},scaled_tunnel:{url:"tunnelB_base.jpg",object:null},scaled_tunnel_alpha:{url:"tunnelB_alpha.jpg",object:null}};class Yy{constructor(t){this.scene=t,this.sceneLights=new Vy(t),this.grid=new Mv(10,10),this.axes=new Ev(3),this.rollerCoaster=new zy,t.add(this.rollerCoaster),this.train=new By,this.rollerCoaster.addTrain(this.train),this.flyingChairs=new ky,this.flyingChairs.position.z=-3.3,this.flyingChairs.position.x=-3,t.add(this.flyingChairs),this.addStreetLamps();const e=new vr(1e3,1e3),n=new ve({color:65280});this.ground=new ee(e,n),this.ground.rotation.x=-Math.PI/2,this.ground.receiveShadow=!0,t.add(this.ground),this.properties={showGrid:!0,showAxes:!0,showRLNormals:!1,showRLTangents:!1,showRLBinormals:!1,showRLWireframe:!1,showRLFlatShading:!1,cameras:"t1"},this.rLHelpersUpdate(),this.worldHelpersUpdate(),this.loadTextures(()=>{this.ground.material=new ve({color:65280}),this.ground.material.onBeforeCompile=function(o){o.uniforms.tierraSampler={type:"t",value:qt.tierra.object},o.uniforms.rocaSampler={type:"t",value:qt.roca.object},o.uniforms.pastoSampler={type:"t",value:qt.pasto.object},o.uniforms.senderoSampler={type:"t",value:qt.sendero.object},o.uniforms.scale1={type:"f",value:1e3},o.uniforms.tailMaskScale={type:"f",value:930},o.uniforms.tailPosX={type:"f",value:449.5},o.uniforms.tailPosY={type:"f",value:451},o.fragmentShader=Wy+o.fragmentShader,o.fragmentShader=o.fragmentShader.replace("#include <map_fragment>",[Xy].join(`
`)),o.vertexShader=o.vertexShader.replace("#define PHONG",`#define PHONG
// Varying 

				varying vec2 vUv;	// Coordenadas de textura que se pasan al fragment shader
`),o.vertexShader=o.vertexShader.replace("#include <fog_vertex>",`#include <fog_vertex>
// Se pasan las coordenadas de textura al fragment 

				vUv = uv;`)};let i=this.remGenerator.fromScene(this.sceneLights.sky).texture;this.ground.receiveShadow=!0,this.ground.needsUpdate=!0,qt.rust.object.repeat=qt.rust_norm.object.repeat=qt.rust_ao.object.repeat=new pt(2,4),this.rollerCoaster.getAllColumns().map(o=>{o.material=new ve({color:16777215}),o.material.map=qt.rust.object,o.material.shininess=30,o.material.normalMap=qt.rust_norm.object,o.material.aoMap=qt.rust_ao.object}),qt.twist_tunnel_alpha.object.repeat=qt.twist_tunnel.object.repeat=qt.twist_tunnel_norm.object.repeat=new pt(4,4),this.rollerCoaster.twistedTunnel.material.color=0,this.rollerCoaster.twistedTunnel.material.alphaTest=.3,this.rollerCoaster.twistedTunnel.material.transparent=!1,this.rollerCoaster.twistedTunnel.material.alphaMap=qt.twist_tunnel_alpha.object,this.rollerCoaster.twistedTunnel.material.map=qt.twist_tunnel.object,this.rollerCoaster.twistedTunnel.material.normalMap=qt.twist_tunnel_norm.object,qt.scaled_tunnel.object.rotation=Math.PI/2,qt.scaled_tunnel.object.repeat=new pt(2.5,1),qt.scaled_tunnel.object.offset.x=.25,this.rollerCoaster.scaledTunnel.material.map=qt.scaled_tunnel.object,this.rollerCoaster.scaledTunnel.material.needsUpdate=!0,qt.scaled_tunnel_alpha.object.rotation=Math.PI/2,qt.scaled_tunnel_alpha.object.flipY=!1,qt.scaled_tunnel_alpha.object.offset.y=.3,this.rollerCoaster.scaledTunnel.material.alphaMap=qt.scaled_tunnel_alpha.object,this.rollerCoaster.scaledTunnel.material.alphaTest=.3,qt.rail.object.repeat=qt.rail_ao.object.repeat=qt.rail_norm.object.repeat=new pt(8,128),this.rollerCoaster.rcMesh.material=new hv({color:16777215}),this.rollerCoaster.rcMesh.material.roughness=.1,this.rollerCoaster.rcMesh.material.metalness=1,this.rollerCoaster.rcMesh.material.envMap=i,this.rollerCoaster.rcMesh.material.envMapIntensity=.1,this.rollerCoaster.rcMesh.material.map=qt.rail.object,this.rollerCoaster.rcMesh.material.aoMap=qt.rail_ao.object,this.rollerCoaster.rcMesh.material.normalMap=qt.rail_norm.object,qt.chtop.object.rotation=Math.PI/2,qt.chtop.object.repeat=new pt(.7,1),this.flyingChairs.top.material=new ve({color:16777215,wireframe:!1}),this.flyingChairs.top.material.map=qt.chtop.object})}loadTextures(t){const e=new $d;e.onLoad=()=>{console.log("All textures loaded"),t()};for(const n in qt){const i=new fv(e),s=qt[n];s.object=i.load("../resources/"+s.url,this.onTextureLoaded.bind(this,n),null,o=>{console.error(o)})}}onTextureLoaded(t,e){t!="sendero"&&(e.wrapS=e.wrapT=Ua),qt[t].object=e,console.log(`Texture ${t} loaded`)}rLHelpersUpdate(){this.properties.showRLNormals?this.rollerCoaster.drawNormals(this.scene):this.rollerCoaster.hideNormals(this.scene),this.properties.showRLTangents?this.rollerCoaster.drawTangents(this.scene):this.rollerCoaster.hideTangents(this.scene),this.properties.showRLBinormals?this.rollerCoaster.drawBinormals(this.scene):this.rollerCoaster.hideBinormals(this.scene)}worldHelpersUpdate(){this.properties.showGrid?this.scene.add(this.grid):this.scene.remove(this.grid),this.properties.showAxes?this.scene.add(this.axes):this.scene.remove(this.axes)}setupUI(t){let e=t.addFolder("Helpers");this.setupWorldHelpers(e),this.setupRLHelpers(e)}setupWorldHelpers(t){let e=t.addFolder("General");e.add(this.properties,"showGrid").name("Grid").onChange(n=>{this.properties.showGrid=n,this.worldHelpersUpdate()}),e.add(this.properties,"showAxes").name("Axes").onChange(n=>{this.properties.showAxes=n,this.worldHelpersUpdate()}),e.add(this.sceneLights.properties,"sunLightHelper").name("Sun").onChange(n=>{this.sceneLights.showSunHelper(n)}),e.add(this.sceneLights.properties,"shadowCamHelper").name("Shadows").onChange(n=>{this.sceneLights.showShadowHelper(n)}),e.add(this.sceneLights.effectController,"elevation",-180,180,.1).name("SunElevation").onChange(n=>{this.sceneLights.skyChanged()})}setupRLHelpers(t){let e=t.addFolder("RLC");e.add(this.properties,"showRLNormals").name("Normals").onChange(n=>{this.rLHelpersUpdate()}),e.add(this.properties,"showRLTangents").name("Tangents").onChange(n=>{this.rLHelpersUpdate()}),e.add(this.properties,"showRLBinormals").name("Binormals").onChange(n=>{this.rLHelpersUpdate()}),e.add(this.properties,"showRLWireframe").name("Wireframe").onChange(n=>{this.rollerCoaster.wireframe(n)}),e.add(this.properties,"showRLFlatShading").name("FlatShading").onChange(n=>{this.rollerCoaster.flatShading(n)})}addTrainCameras(t,e,n){t.name=Fs.TrainFront,e.name=Fs.TrainBack,n.name=Fs.TrainSide,this.rollerCoaster.add(t),this.rollerCoaster.add(e),this.rollerCoaster.add(n)}addFlyingChairCamera(t){this.flyingChairs.chairs[0].add(t)}addStreetLamps(){const t=new qd([new v(-3,0,-5),new v(-.5,0,-3),new v(-.75,0,0),new v(2,0,2.5),new v(2.5,0,5),new v(2,0,9),new v(-.5,0,11.5),new v(-6,0,8),new v(-6,0,3),new v(-6.5,0,0),new v(-6,0,-2),new v(-4,0,-4.5)]),e=15,n=.5;for(let i=0;i<e;i++){let s=t.getPointAt(i/e),o=new Gy(n);o.position.copy(s),this.scene.add(o),this.sceneLights.addLamp(o)}}animate(){this.rollerCoaster.animate(),this.flyingChairs.animate()}}var qy=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function $y(r){return r&&r.__esModule&&Object.prototype.hasOwnProperty.call(r,"default")?r.default:r}var gf={exports:{}};(function(r,t){(function(e,n){r.exports=n()})(qy,function(){var e=function(){function n(f){return o.appendChild(f.dom),f}function i(f){for(var g=0;g<o.children.length;g++)o.children[g].style.display=g===f?"block":"none";s=f}var s=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(f){f.preventDefault(),i(++s%o.children.length)},!1);var a=(performance||Date).now(),l=a,c=0,h=n(new e.Panel("FPS","#0ff","#002")),u=n(new e.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var d=n(new e.Panel("MB","#f08","#201"));return i(0),{REVISION:16,dom:o,addPanel:n,showPanel:i,begin:function(){a=(performance||Date).now()},end:function(){c++;var f=(performance||Date).now();if(u.update(f-a,200),f>l+1e3&&(h.update(1e3*c/(f-l),100),l=f,c=0,d)){var g=performance.memory;d.update(g.usedJSHeapSize/1048576,g.jsHeapSizeLimit/1048576)}return f},update:function(){a=this.end()},domElement:o,setMode:i}};return e.Panel=function(n,i,s){var o=1/0,a=0,l=Math.round,c=l(window.devicePixelRatio||1),h=80*c,u=48*c,d=3*c,f=2*c,g=3*c,_=15*c,p=74*c,m=30*c,S=document.createElement("canvas");S.width=h,S.height=u,S.style.cssText="width:80px;height:48px";var x=S.getContext("2d");return x.font="bold "+9*c+"px Helvetica,Arial,sans-serif",x.textBaseline="top",x.fillStyle=s,x.fillRect(0,0,h,u),x.fillStyle=i,x.fillText(n,d,f),x.fillRect(g,_,p,m),x.fillStyle=s,x.globalAlpha=.9,x.fillRect(g,_,p,m),{dom:S,update:function(b,R){o=Math.min(o,b),a=Math.max(a,b),x.fillStyle=s,x.globalAlpha=1,x.fillRect(0,0,h,_),x.fillStyle=i,x.fillText(l(b)+" "+n+" ("+l(o)+"-"+l(a)+")",d,f),x.drawImage(S,g+c,_,p-c,m,g,_,p-c,m),x.fillRect(g+p-c,_,c,m),x.fillStyle=s,x.globalAlpha=.9,x.fillRect(g+p-c,_,c,l((1-b/R)*m))}}},e})})(gf);var jy=gf.exports;const Zy=$y(jy);let Gl,ii,Ps,ri,Ni,en,Ri,ar,Ml,bl,Sl,Ca,Us;const ke={currentCamera:0,currentCameraStr:"Orbital"},_f=["Orbital","FPV","Vagon Frente","Vagon Trasero","Vagon","Silla Voladora","Montaña Orbital","Sillas Orbital"],Ky={Orbital:0,FPV:1,"Vagon Frente":2,"Vagon Trasero":3,Vagon:4,"Silla Voladora":5,"Montaña Orbital":6,"Sillas Orbital":7};let xf;const vf=.2;let Jy=new v(3,2,1);const od=0,ld=6,cd=7;let fr=new v(0,0,0),hd=new v(-3,0,5);const qa=new Zy;class Qy extends Cv{constructor(t,e){super(t,e)}extendedUpdate(t){this.update(t),ar.position.y=vf}}function tM(){Ps=document.getElementById("container3D"),ii=new Da,ii.shadowMap.enabled=!0,new Da,new Da,Gl=new Kx,Ps.appendChild(ii.domElement),Ri=new Ae(75,window.innerWidth/window.innerHeight,.1,100),Ri.position.copy(Jy),Ri.lookAt(fr.x,fr.y,fr.z),ar=new Ae(75,window.innerWidth/window.innerHeight,.1,100),ar.position.set(0,vf,0),Ml=new Ae(45,window.innerWidth/window.innerHeight,.1,100),bl=new Ae(45,window.innerWidth/window.innerHeight,.1,100),Sl=new Ae(45,window.innerWidth/window.innerHeight,.1,100),Ca=new Ae(45,window.innerWidth/window.innerHeight,.1,100),Ca.position.set(0,-.93,0),ri=new Yy(Gl),ri.addTrainCameras(Ml,bl,Sl),ri.addFlyingChairCamera(Ca),ri.remGenerator=new fy(ii),en=new Tv(Ri,ii.domElement),en.enablePan=!1,Ni=new Qy(ar,ii.domElement),Ni.lookSpeed=.03,Ni.movementSpeed=.5,Ni.enabled=!1,Us=[Ri,ar,bl,Ml,Sl,Ca,Ri,Ri],window.addEventListener("resize",ud),document.addEventListener("keydown",nM),ud();let r=new Oy;xf=eM(r),ri.setupUI(r),qa.showPanel(0),document.body.appendChild(qa.dom)}function eM(r){return r.add(ke,"currentCameraStr",_f).name("Camaras").onChange(t=>{ke.currentCamera=Ky[t],yf()})}function nM(r){switch(r.key){case"c":iM();break}}function iM(){ke.currentCamera+=1,ke.currentCamera=ke.currentCamera%Us.length,ke.currentCameraStr=_f[ke.currentCamera],yf(),xf.updateDisplay()}function yf(){Ni.enabled=ke.currentCamera==1,en.enabled=ke.currentCamera==od||ke.currentCamera==ld||ke.currentCamera==cd,ke.currentCamera==od&&(en.target.copy(fr),en.target0.copy(fr),en.reset()),ke.currentCamera==ld&&(en.target.copy(hd),en.target0.copy(hd),en.reset()),ke.currentCamera==cd&&(en.target.copy(ri.flyingChairs.position),en.target0.copy(ri.flyingChairs.position),en.reset())}function ud(){for(let r=0;r<Us.length;r++)Us[r].aspect=Ps.offsetWidth/Ps.offsetHeight,Us[r].updateProjectionMatrix();ii.setSize(Ps.offsetWidth,Ps.offsetHeight),Ni.handleResize()}function Mf(){qa.begin(),Ni.extendedUpdate(.08),ri.animate(),ii.render(Gl,Us[ke.currentCamera]),qa.end(),requestAnimationFrame(Mf)}tM();Mf();
